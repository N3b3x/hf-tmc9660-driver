 ...
 * feedback and system monitoring.
 */
namespace ADC {
 ...
 * measurement and repeat MUX1 (AIN1) measurement. 13:12   | ADC1_MUX2_CFG         | RW     |
 * Measurement position of MUX2 input in ADC1 sequence. 11:10   | ADC1_MUX1_CFG         | RW     |
 * Measurement position of MUX1 input in ADC1 sequence. 9:8     | ADC1_MUX0_CFG         | RW     |
 * Measurement position of MUX0 input in ADC1 sequence. 7       | ADC0_MUX2_DETOUR      | RW     |
 * Skip second MUX2 measurement and repeat MUX1 (AIN0) measurement. 6       | ADC0_MUX3_DIS | RW |
 * Disable measurement of MUX3 input (supply voltage). 5:4     | ADC0_MUX2_CFG         | RW     |
 * Measurement position of MUX2 input in ADC0 sequence. 3:2     | ADC0_MUX1_CFG         | RW     |
 * Measurement position of MUX1 input in ADC0 sequence. 1:0     | ADC0_MUX0_CFG         | RW     |
 * Measurement position of MUX0 input in ADC0 sequence.
 *
 ...
 * appropriate filtering reduces switching noise from PWM operations.
 */
/**
