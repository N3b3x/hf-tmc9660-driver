 ...
 *  NUMBER | OPERATION      | TYPE                | MOTOR/BANK         | VALUE                |
 * DESCRIPTION
 *  ------ | -------------- | ------------------- | ------------------ | -------------------- |
 * --------------------------------------------------------------- 3   | MST            | - | - | -
 * | Stops motor movement 5   | SAP            | parameter           | 0                  | value |
 * Sets axis parameter (motion control specific settings) 6   | GAP            | parameter | 0 | -
 * | Gets axis parameter (read out motion control specific settings) 7   | STAP           | 0xFFF |
 * 0xF                | 0xFFFFFFFF           | Stores all storable parameters to external memory 9
 * | SGP            | parameter           | 0,2,3              | value                | Sets global
 * parameter (module/user settings) 10   | GGP            | parameter           | - | - | Gets
 * global parameter (module/user settings) 13   | RFS            | START|STOP|STATUS   | 0 | - |
 * Reference search 14   | SIO            | port number         | 0                  | 0,1 | Sets
 * digital output to specified value 15   | GIO            | port number         | 0: digital, 1:
 * ana | -                    | Gets value of analog/digital input 19   | CALC           | operation
 * | -                  | value                | Arithmetic operation (accumulator and value) 20   |
 * COMP           | -                   | -                  | value                | Compares
 * accumulator with value 21   | JC             | condition           | -                  | address
 * | Jump conditional 22   | JA             | -                   | -                  | address |
 * Jump absolute 23   | CSUB           | -                   | -                  | address | Calls
 * subroutine 24   | RSUB           | -                   | -                  | - | Returns from
 * subroutine 25   | EI             | -                   | -                  | interrupt number |
 * Enables interrupt 26   | DI             | -                   | -                  | interrupt
 * number     | Disables interrupt 27   | WAIT           | condition           | - | ticks | Waits
 * with further program execution 28   | STOP           | -                   | -                  |
 * -                    | Stops program execution 33   | CALCX          | type                | - |
 * -                    | Arithmetic operation (accumulator and X-register) 34   | AAP            |
 * parameter           | 0                  | -                    | Accumulator to axis parameter
 *    35   | AGP            | parameter           | 0,2,3              | -                    |
 * Accumulator to global parameter 36   | CLE            | flag                | - | - | Clears an
 * error flag 37   | VECT           | interrupt number    | -                  | address | Defines
 * interrupt vector 38   | RETI           | -                   | -                  | - | Returns
 * from interrupt 40   | CALCVV         | type                | user var 1         | user var 2 |
 * Arithmetic: user variable and user variable 41   | CALCVA         | type                | user
 * variable      | -                    | Arithmetic: user variable and accumulator 42   | CALCAV |
 * type                | user variable      | -                    | Arithmetic: accumulator and
 * user variable 43   | CALCVX         | type                | user variable      | - | Arithmetic:
 * user variable and X register 44   | CALCXV         | type                | user variable      | -
 * | Arithmetic: X register and user variable 45   | CALCV          | type                | - |
 * value                | Arithmetic: user variable and direct value 48   | RST            | - | -
 * | address              | Restarts the program from the given address 49   | DJNZ           | user
 * variable       | -                  | address              | Decrement and jump if not zero 55 |
 * SIV            | -                   | -                  | value                | Sets indexed
 * variable 56   | GIV            | -                   | -                  | - | Gets indexed
 * variable 57   | AIV            | -                   | -                  | - | Accumulator to
 * indexed variable 128   | ApplStop        | -                  | -                  | - | Stops a
 * running TMCL program 129   | ApplRun         | 0: current, 1: addr| -                  | address
 * | Starts/continues TMCL program 130   | ApplStep        | -                  | - | - | Executes
 * only the next TMCL command 131   | ApplReset       | -                  | -                  | -
 * | Stops and resets program counter 132   | DownloadStart   | -                  | - | - | Enter
 * download mode (store script) 133   | DownloadEnd     | -                  | -                  |
 * -                    | End download mode 134   | ReadMem         | -                  | - |
 * address              | Returns script command at address 135   | GetStatusScript | - | - | - |
 * Gets status of script 136   | GetVersion      | -                  | -                  | - |
 * Gets version of system 137   | FactoryDefault  | -                  | -                  | - |
 * Clears settings stored in external memory 141   | Breakpoint      | 0:add,1:del,2:all,3:max| - |
 * address              | Manage breakpoints 142   | RamDebug        | see Table 16       | see
 * Table 16       | see Table 16         | Access to RAMDebug control 157   | GetInfo         |
 * 0:ID, 1:Version    | -                  | -                    | Gets ID and version info 242   |
 * Boot            | 0x81               | 0x92               | 0xA3B4C5D6           | Returns the
...
#define OP_LIST(X)                                                                                 \
  X(NOP, 0,                                                                                        \
    /*!< For no operation placeholder. (Not defined in datasheet, only for practical sake)*/)      \
  ...
  X(CALCX, 33,                                                                                     \
    /*!< Arithmetic accumulator <-> X-register. TYPE: type, MOTOR/BANK: -, VALUE: -. */)           \
  X(AAP, 34, /*!< Accumulator to Axis Parameter. TYPE: parameter, MOTOR/BANK: 0, VALUE: -. */)     \
  X(AGP, 35,                                                                                       \
    /*!< Accumulator to Global Parameter. TYPE: parameter, MOTOR/BANK: 0,2,3, VALUE: -. */)        \
  X(CLE, 36, /*!< Clear Error Flag. TYPE: flag, MOTOR/BANK: -, VALUE: -. */)                       \
  X(VECT, 37,                                                                                      \
    /*!< Define Interrupt Vector. TYPE: interrupt number, MOTOR/BANK: -, VALUE: address. */)       \
  ...
  X(DJNZ, 49,                                                                                      \
    /*!< Decrement-and-Jump if not zero. TYPE: user variable, MOTOR/BANK: -, VALUE: address. */)   \
  ...
  X(DownloadStart, 132,                                                                            \
    /*!< Enter download (script upload) mode. TYPE: -, MOTOR/BANK: -, VALUE: -. */)                \
  ...
  X(GetInfo, 157,                                                                                  \
    /*!< Generic info (ID, version, etc.). TYPE: 0 (ID), 1 (Version), MOTOR/BANK: -, VALUE: -. */) \
 ...
 *  ------ | --------------------------- |
 * --------------------------------------------------------------- 100   | REPLY_OK | Command
 * executed successfully. 101   | REPLY_CMD_LOADED            | Command loaded successfully. 1   |
 * REPLY_CHKERR                | Check error occurred (e.g., checksum error). 2   |
 * REPLY_INVALID_CMD           | Invalid command received (unknown command number). 3   |
 * REPLY_WRONG_TYPE            | Wrong type of data received (TYPE field invalid). 4   |
 * REPLY_INVALID_VALUE         | Invalid value received (VALUE field out of range). 6   |
 * REPLY_CMD_NOT_AVAILABLE     | Command not available (not supported in this mode). 7   |
 * REPLY_CMD_LOAD_ERROR        | Error occurred while loading command (storage error). 9   |
 * REPLY_MAX_EXCEEDED          | Maximum limit exceeded (e.g., too many breakpoints). 10   |
 * REPLY_DOWNLOAD_NOT_POSSIBLE | Download operation not possible (misuse or memory full).
 */
#define REPLY_CODE_LIST(X)                                                                         \
  ...
  X(REPLY_DOWNLOAD_NOT_POSSIBLE, 10,                                                               \
    /*!< Download operation not possible (misuse or memory full). */)
 ...
 *  NUMBER | TYPE (subcode)      | MOTOR/BANK                                      | VALUE |
 * DESCRIPTION
 *  ------ | ------------------- | ----------------------------------------------- |
 * --------------------------------------------------------------------- |
 * ---------------------------------------------------------- 0   | INITIALISE_RESET    | - | - |
 * Initialize and reset RAMDebug configuration & buffers. 1   | SET_SAMPLE_COUNT    | - | Number |
 * Set total number of samples to collect (not per-channel). 3   | SET_PRESCALER       | - |
 * Prescale                                                              | Set divider for sampling
 * rate (divider = VALUE+1). 4   | SET_CHANNEL         | Type: 0=Disabled, 1=Parameter, 3=Global
 * param   | Motor/Bank: 0xFF000000, AP/GP number: 0x00000FFF                      | Configure
 * capture channel. 5   | SET_TRIGGER_CHANNEL | Type: 0=Disabled, 1=Parameter, 3=Global param   |
 * Motor/Bank: 0xFF000000, AP/GP number: 0x00000FFF                      | Specify source of trigger
 * data. 6   | SET_TRIGGER_MASK_SHIFT | Shift                                       | Mask | Specify
 * mask and shift for trigger value. 7   | ENABLE_TRIGGER      | Type: 0=Uncond, 1=RiseS, 2=FallS,
 * 3=DualS,      | Threshold                                                             | Start
 * measurement by enabling trigger. |                     | 4=RiseU, 5=FallU, 6=BothU | | 8   |
 * GET_STATE           | -                                               | - | Request state of
 * RAMDebug (see RamDebugState). 9   | READ_SAMPLE         | Index | - | Download sampled values at
 * index. 10   | GET_INFO            | -                                               | 0=Max
 * channels, 1=Buffer size, 2=RAMDebug freq, 3=Captured count,     | Read general info. | | |
 * 4=Prescaler on trigger                                                | 11   | GET_CHANNEL_TYPE
 * | Index                                           | - | Read channel type info. 12   |
 * GET_CHANNEL_ADDRESS | Index                                           | - | Read channel address.
 *    13   | SET_PRETRIGGER_COUNT | -                                              | Number | Set
 * total number of pretrigger samples (not per-channel). 14   | GET_PRETRIGGER_COUNT | - | - | Get
 * total number of pretrigger samples.
 */
#define RAMDEBUG_TYPE_LIST(X)                                                                      \
  ...
  X(SET_PRESCALER, 3,                                                                              \
    /*!< VALUE: Prescale value. Sets divider for sampling rate (divider = VALUE+1). */)            \
  ...
  X(SET_TRIGGER_MASK_SHIFT, 6,                                                                     \
    /*!< Specify mask and shift for trigger value. MOTOR/BANK: Shift. VALUE: Mask. */)             \
  ...
  X(SET_PRETRIGGER_COUNT, 13,                                                                      \
    /*!< Set total number of pretrigger samples (not per-channel). VALUE: Number of samples. */)   \
 ...
 *  ------ | ---------- |
 * ------------------------------------------------------------------------------------------- 0   |
 * Idle       | RAMDebug is not running and can be configured. Use type code 0 to enter this state.
 *     1   | Trigger    | RAMDebug is waiting for the trigger event to happen. When updating a value
 * that RAMDebug | is triggering on, ensure this state is reached before updating. 2   | Capture |
 * RAMDebug has been triggered and is capturing samples. 3   | Complete   | RAMDebug has finished
 * capturing samples. The data can now be downloaded using type code 9. 4   | Pretrigger | RAMDebug
 * is capturing samples for the pretrigger.
 */
#define RAMDEBUG_STATE_LIST(X)                                                                     \
  ...
  X(COMPLETE, 3,                                                                                   \
    /*!< Complete: Finished capturing samples. Data can be downloaded using type code 9. */)       \
...
//--------------------------------------
/**
 * @brief Non-motion parameters in bank 0: communication, I/O, heartbeat, hibernation, loops,
 * auto-start, etc.
 *
...
#define GLOBAL_PARAM_BANK0_LIST(X)                                                                 \
  ...
  X(HEARTBEAT_MONITORING_CONFIG, 3,                                                                \
    /*!< 0: DISABLED, 1: UART, 2: SPI, 3: UART+SPI. Default: 0. RWE */)                            \
  X(HEARTBEAT_MONITORING_TIMEOUT, 4,                                                               \
    /*!< Heartbeat timeout [ms] [1…4294967295]. Default: 100. RWE */)                              \
  X(IO_DIRECTION_MASK, 5, /*!< GPIO direction mask [bit=1→output]. Default: 0. RWE */)             \
  X(IO_INPUT_PULLUP_PULLDOWN_ENABLE_MASK, 6,                                                       \
    /*!< GPIO pull-enable mask [bit=1→pull enabled]. Default: 0. RWE */)                           \
  X(IO_INPUT_PULLUP_PULLDOWN_DIRECTION_MASK, 7,                                                    \
    /*!< GPIO pull-dir mask [bit=1→pull-up]. Default: 0. RWE */)                                   \
 ...
 *
 * These parameters configure the MOSFET gate driver for the TMC9660, including output polarity,
 * break-before-make timing, adaptive drive time, drive times, current limits, and bootstrap current
 * limit.
 *
 ...
 *  ---- | -------------------------------- |
 * --------------------------------------------------------------------------- 233  |
 * PWM_L_OUTPUT_POLARITY            | PWM_L output polarity. 0: ACTIVE_HIGH, 1: ACTIVE_LOW 234  |
 * PWM_H_OUTPUT_POLARITY            | PWM_H output polarity. 0: ACTIVE_HIGH, 1: ACTIVE_LOW 235  |
 * BREAK_BEFORE_MAKE_TIME_LOW_UVW   | Break-before-make time for low side UVW [8.33ns units] 0...255
 *  236  | BREAK_BEFORE_MAKE_TIME_HIGH_UVW  | Break-before-make time for high side UVW [8.33ns
 * units] 0...255 237  | BREAK_BEFORE_MAKE_TIME_LOW_Y2    | Break-before-make time for low side Y2
 * [8.33ns units] 0...255 238  | BREAK_BEFORE_MAKE_TIME_HIGH_Y2   | Break-before-make time for high
 * side Y2 [8.33ns units] 0...255 239  | USE_ADAPTIVE_DRIVE_TIME_UVW      | Adaptive drive time UVW.
 * 0: DISABLED, 1: ENABLED 240  | USE_ADAPTIVE_DRIVE_TIME_Y2       | Adaptive drive time Y2. 0:
 * DISABLED, 1: ENABLED 241  | DRIVE_TIME_SINK_UVW              | Discharge time UVW [0...255]
 * (1s/120MHz) × (2×value+3) 242  | DRIVE_TIME_SOURCE_UVW            | Charge time UVW [0...255]
 * (1s/120MHz) × (2×value+3) 243  | DRIVE_TIME_SINK_Y2               | Discharge time Y2 [0...255]
 * (1s/120MHz) × (2×value+3) 244  | DRIVE_TIME_SOURCE_Y2             | Charge time Y2 [0...255]
 * (1s/120MHz) × (2×value+3) 245  | UVW_SINK_CURRENT                 | See
 * ::tmc9660::tmcl::GateCurrentSink 246  | UVW_SOURCE_CURRENT               | See
 * ::tmc9660::tmcl::GateCurrentSource 247  | Y2_SINK_CURRENT                  | See
 * ::tmc9660::tmcl::GateCurrentSink 248  | Y2_SOURCE_CURRENT                | See
 * ::tmc9660::tmcl::GateCurrentSource 249  | BOOTSTRAP_CURRENT_LIMIT          | See
 * ::tmc9660::tmcl::BootstrapCurrentLimit
 */
#define GATE_DRIVER_LIST(X)                                                                        \
  ...
  X(BREAK_BEFORE_MAKE_TIME_LOW_UVW, 235,                                                           \
    /*!< Break-before-make time for low side UVW [8.33ns units] 0...255. */)                       \
  X(BREAK_BEFORE_MAKE_TIME_HIGH_UVW, 236,                                                          \
    /*!< Break-before-make time for high side UVW [8.33ns units] 0...255. */)                      \
  X(BREAK_BEFORE_MAKE_TIME_LOW_Y2, 237,                                                            \
    /*!< Break-before-make time for low side Y2 [8.33ns units] 0...255. */)                        \
  X(BREAK_BEFORE_MAKE_TIME_HIGH_Y2, 238,                                                           \
    /*!< Break-before-make time for high side Y2 [8.33ns units] 0...255. */)                       \
...
inline const char *to_string(BootstrapCurrentLimit s) {
  switch (s) {
#define X(NAME, VALUE, DOC)                                                                        \
  case BootstrapCurrentLimit::NAME:                                                                \
    return #NAME;
    BOOTSTRAP_CURRENT_LIMIT_LIST(X)
#undef X
  default:
 ...
 *  ------ | ------------------------ |
 * --------------------------------------------------------------------------- 254  |
 * UVW_LOW_SIDE_ENABLE      | Enable overcurrent protection for UVW phases low side. 0: DISABLED, 1:
 * ENABLED. Default: 1. 255  | UVW_HIGH_SIDE_ENABLE     | Enable overcurrent protection for UVW
 * phases high side. 0: DISABLED, 1: ENABLED. Default: 1. 256  | Y2_LOW_SIDE_ENABLE       | Enable
 * overcurrent protection for Y2 phase low side. 0: DISABLED, 1: ENABLED. Default: 1. 257  |
 * Y2_HIGH_SIDE_ENABLE      | Enable overcurrent protection for Y2 phase high side. 0: DISABLED, 1:
 * ENABLED. Default: 1. 258  | UVW_LOW_SIDE_THRESHOLD   | Threshold for UVW phases low side [0-15].
 * Default: 0. 259  | UVW_HIGH_SIDE_THRESHOLD  | Threshold for UVW phases high side [0-15]. Default:
 * 0. 260  | Y2_LOW_SIDE_THRESHOLD    | Threshold for Y2 phase low side [0-15]. Default: 0. 261  |
 * Y2_HIGH_SIDE_THRESHOLD   | Threshold for Y2 phase high side [0-15]. Default: 0. 262  |
 * UVW_LOW_SIDE_BLANKING    | Blanking time for UVW phases low side [0-7]. Default: 2. 263  |
 * UVW_HIGH_SIDE_BLANKING   | Blanking time for UVW phases high side [0-7]. Default: 2. 264  |
 * Y2_LOW_SIDE_BLANKING     | Blanking time for Y2 phase low side [0-7]. Default: 2. 265  |
 * Y2_HIGH_SIDE_BLANKING    | Blanking time for Y2 phase high side [0-7]. Default: 2. 266  |
 * UVW_LOW_SIDE_DEGLITCH    | Deglitch time for UVW phases low side [0-7]. Default: 6. 267  |
 * UVW_HIGH_SIDE_DEGLITCH   | Deglitch time for UVW phases high side [0-7]. Default: 6. 268  |
 * Y2_LOW_SIDE_DEGLITCH     | Deglitch time for Y2 phase low side [0-7]. Default: 6. 269  |
 * Y2_HIGH_SIDE_DEGLITCH    | Deglitch time for Y2 phase high side [0-7]. Default: 6. 270  |
 * UVW_LOW_SIDE_USE_VDS     | Use VDS measurement for UVW phases low side. 0: DISABLED, 1: ENABLED.
 * Default: 1. 271  | Y2_LOW_SIDE_USE_VDS      | Use VDS measurement for Y2 phase low side. 0:
 * DISABLED, 1: ENABLED. Default: 1.
 */
#define OVERCURRENT_PROTECTION_LIST(X)                                                             \
  ...
  X(UVW_HIGH_SIDE_BLANKING, 263,                                                                   \
    /*!< Blanking time for UVW phases high side [0-7]. Default: 2. */)                             \
  ...
  X(UVW_HIGH_SIDE_DEGLITCH, 267,                                                                   \
    /*!< Deglitch time for UVW phases high side [0-7]. Default: 6. */)                             \
  ...
  X(UVW_LOW_SIDE_USE_VDS, 270,                                                                     \
    /*!< Use VDS measurement for UVW phases low side. 0: DISABLED, 1: ENABLED. Default: 1. */)     \
  X(Y2_LOW_SIDE_USE_VDS, 271,                                                                      \
    /*!< Use VDS measurement for Y2 phase low side. 0: DISABLED, 1: ENABLED. Default: 1. */)
...
inline const char *to_string(OvercurrentProtection p) {
  switch (p) {
#define X(NAME, VALUE, DOC)                                                                        \
  case OvercurrentProtection::NAME:                                                                \
    return #NAME;
    OVERCURRENT_PROTECTION_LIST(X)
#undef X
  default:
...
inline const char *to_string(OvercurrentThreshold t) {
  switch (t) {
#define X(NAME, VALUE, DOC)                                                                        \
  case OvercurrentThreshold::NAME:                                                                 \
    return #NAME;
    OVERCURRENT_THRESHOLD_LIST(X)
#undef X
  default:
...
#define UNDERVOLTAGE_PROTECTION_LIST(X)                                                            \
  ...
  X(BST_UVW_ENABLE, 252,                                                                           \
    /*!< Enable protection for UVW bootstrap capacitors [0, 1]. Default: 1. */)                    \
...
inline const char *to_string(UndervoltageProtection p) {
  switch (p) {
#define X(NAME, VALUE, DOC)                                                                        \
  case UndervoltageProtection::NAME:                                                               \
    return #NAME;
    UNDERVOLTAGE_PROTECTION_LIST(X)
#undef X
  default:
...
#define VGS_SHORT_PROTECTION_LIST(X)                                                               \
  X(UVW_LOW_SIDE_ON_ENABLE, 272,                                                                   \
    /*!< Enable VGS short protection for ON transition of UVW low side [0, 1]. Default: 1. */)     \
  X(UVW_LOW_SIDE_OFF_ENABLE, 273,                                                                  \
    /*!< Enable VGS short protection for OFF transition of UVW low side [0, 1]. Default: 1. */)    \
  X(UVW_HIGH_SIDE_ON_ENABLE, 274,                                                                  \
    /*!< Enable VGS short protection for ON transition of UVW high side [0, 1]. Default: 1. */)    \
  X(UVW_HIGH_SIDE_OFF_ENABLE, 275,                                                                 \
    /*!< Enable VGS short protection for OFF transition of UVW high side [0, 1]. Default: 1. */)   \
  X(Y2_LOW_SIDE_ON_ENABLE, 276,                                                                    \
    /*!< Enable VGS short protection for ON transition of Y2 low side [0, 1]. Default: 1. */)      \
  X(Y2_LOW_SIDE_OFF_ENABLE, 277,                                                                   \
    /*!< Enable VGS short protection for OFF transition of Y2 low side [0, 1]. Default: 1. */)     \
  X(Y2_HIGH_SIDE_ON_ENABLE, 278,                                                                   \
    /*!< Enable VGS short protection for ON transition of Y2 high side [0, 1]. Default: 1. */)     \
  X(Y2_HIGH_SIDE_OFF_ENABLE, 279,                                                                  \
    /*!< Enable VGS short protection for OFF transition of Y2 high side [0, 1]. Default: 1. */)    \
  X(UVW_BLANKING, 280,                                                                             \
    /*!< VGS short protection blanking time for UVW phases [0-3]. Default: 1. */)                  \
  X(Y2_BLANKING, 281, /*!< VGS short protection blanking time for Y2 phase [0-3]. Default: 1. */)  \
  X(UVW_DEGLITCH, 282,                                                                             \
    /*!< VGS short protection deglitch time for UVW phases [0-7]. Default: 1. */)                  \
 ...
 *  ------ | --------------------- |
 * ----------------------------------------------------------------- 0   | MOTOR_TYPE            |
 * Motor type selection. See MotorType enum. Default: 0 (NO_MOTOR). RWE 1   | MOTOR_POLE_PAIRS |
 * Number of pole pairs for motor [0-127]. Default: 1. RWE 2   | MOTOR_DIRECTION       | Motor
 * direction. 0: NOT_INVERTED, 1: INVERTED. Default: 0. RWE 3   | MOTOR_PWM_FREQUENCY   | PWM
 * frequency in Hz [10000-100000]. Default: 25000. RWE 4   | COMMUTATION_MODE      | Motor
 * commutation mode. See CommutationMode enum. Default: 0 (SYSTEM_OFF). RW 5   |
 * OUTPUT_VOLTAGE_LIMIT  | PID UQ/UD output limit for circular limiter [0-32767]. Default: 8000. RWE
 *     8   | PWM_SWITCHING_SCHEME  | PWM switching scheme. See PwmSwitchingScheme enum. Default: 1
 * (SVPWM). RWE
 */
#define MOTOR_CONFIG_LIST(X)                                                                       \
  ...
  X(COMMUTATION_MODE, 4,                                                                           \
    /*!< Motor commutation mode. See CommutationMode enum. Default: 0 (SYSTEM_OFF). RW */)         \
  X(OUTPUT_VOLTAGE_LIMIT, 5,                                                                       \
    /*!< PID UQ/UD output limit for circular limiter [0-32767]. Default: 8000. RWE */)             \
  X(PWM_SWITCHING_SCHEME, 8,                                                                       \
    /*!< PWM switching scheme. See PwmSwitchingScheme enum. Default: 1 (SVPWM). RWE */)            \
 ...
 * - Voltage is defined by the `OPENLOOP_VOLTAGE` parameter (PWM duty cycle relative to supply
 * voltage).
 ...
 *   - Torque is applied to the motor, and the flux value is assumed zero unless field weakening is
 * active.
 ...
 *  NUMBER | NAME                        | DESCRIPTION
 *  ------ | --------------------------- |
 * ----------------------------------------------------------------- 0   | SYSTEM_OFF | System off
 * (default after power-on/reset). 1   | SYSTEM_OFF_LOW_SIDE_FETS_ON | All low-side FETs on (coils
 * shorted to ground). 2   | SYSTEM_OFF_HIGH_SIDE_FETS_ON| All high-side FETs on (coils shorted to
 * supply). 3   | FOC_OPENLOOP_VOLTAGE_MODE   | Open-loop voltage mode (constant duty cycle). 4   |
 * FOC_OPENLOOP_CURRENT_MODE   | Open-loop current mode (constant current). 5   | FOC_ABN | FOC with
 * ABN encoder feedback. 6   | FOC_HALL_SENSOR             | FOC with Hall sensor feedback. 7   |
 * RESERVED                    | Reserved. 8   | FOC_SPI_ENC                 | FOC with SPI encoder
 * feedback. 9   | IDLE_MOTOR_PWM_BEHAVIOR     | Idle motor PWM behavior.
 */
 ...
 *  ------ | ------------------------ |
 * ----------------------------------------------------------------- 0   | PWM_ON_WHEN_MOTOR_IDLE |
 * PWM stays on when motor is idle (all phases same voltage). 1   | PWM_OFF_WHEN_MOTOR_IDLE  | PWM
 * off (high-Z, motor floating) [default].
 */
...
inline const char *to_string(IdleMotorPwmBehavior behavior) {
  switch (behavior) {
#define X(NAME, VALUE, DOC)                                                                        \
  case IdleMotorPwmBehavior::NAME:                                                                 \
    return #NAME;
    IDLE_MOTOR_PWM_BEHAVIOR_LIST(X)
#undef X
  default:
 ...
 *  NUMBER | NAME                       | DESCRIPTION
 *  ------ | -------------------------- |
 * ----------------------------------------------------------------- 12   | ADC_SHUNT_TYPE | Shunt
 * type for ADC measurements. See AdcShuntType enum. Default: 4 (BOTTOM_SHUNTS). 13   | ADC_I0_RAW
 * | Raw ADC measurement for I0 shunt [-32768, 32767]. Read-only. 14   | ADC_I1_RAW | Raw ADC
 * measurement for I1 shunt [-32768, 32767]. Read-only. 15   | ADC_I2_RAW                 | Raw ADC
 * measurement for I2 shunt [-32768, 32767]. Read-only. 16   | ADC_I3_RAW                 | Raw ADC
 * measurement for I3 shunt [-32768, 32767]. Read-only. 17   | CSA_GAIN_ADC_I0_TO_ADC_I2  | Current
 * sense amplifier gain for ADC I0, I1 and I2. See CsaGain enum. Default: 1 (GAIN_10X). 18   |
 * CSA_GAIN_ADC_I3            | Current sense amplifier gain for ADC I3. See CsaGain enum. Default:
 * 1 (GAIN_10X). 19   | CSA_FILTER_ADC_I0_TO_ADC_I2| Current sense amplifier filter for ADC I0, I1
 * and I2. See CsaFilter enum. Default: 0 (T_0_55_MICROSEC). 20   | CSA_FILTER_ADC_I3          |
 * Current sense amplifier filter for ADC I3. See CsaFilter enum. Default: 0 (T_0_55_MICROSEC). 21
 * | CURRENT_SCALING_FACTOR     | Current scaling factor converting internal units to real-world
 * units [1, 65535]. Default: 520. 22   | PHASE_UX1_ADC_MAPPING      | Mapping ADC to UX1. See
 * AdcMapping enum. Default: 0 (ADC_I0). 23   | PHASE_VX2_ADC_MAPPING      | Mapping ADC to VX2. See
 * AdcMapping enum. Default: 1 (ADC_I1). 24   | PHASE_WY1_ADC_MAPPING      | Mapping ADC to WY1. See
 * AdcMapping enum. Default: 2 (ADC_I2). 25   | PHASE_Y2_ADC_MAPPING       | Mapping ADC to Y2. See
 * AdcMapping enum. Default: 3 (ADC_I3). 26   | ADC_I0_SCALE               | Scaling applied to ADC
 * I0 [1, 32767]. Default: 1024. 27   | ADC_I1_SCALE               | Scaling applied to ADC I1 [1,
 * 32767]. Default: 1024. 28   | ADC_I2_SCALE               | Scaling applied to ADC I2 [1, 32767].
 * Default: 1024. 29   | ADC_I3_SCALE               | Scaling applied to ADC I3 [1, 32767]. Default:
 * 1024. 30   | ADC_I0_INVERTED            | Invert the reading of ADC I0. 0: NOT_INVERTED, 1:
 * INVERTED. Default: 1. 31   | ADC_I1_INVERTED            | Invert the reading of ADC I1. 0:
 * NOT_INVERTED, 1: INVERTED. Default: 1. 32   | ADC_I2_INVERTED            | Invert the reading of
 * ADC I2. 0: NOT_INVERTED, 1: INVERTED. Default: 1. 33   | ADC_I3_INVERTED            | Invert the
 * reading of ADC I3. 0: NOT_INVERTED, 1: INVERTED. Default: 1. 34   | ADC_I0_OFFSET              |
 * Offset applied to ADC I0 measurement [-32768, 32767]. Default: 0. 35   | ADC_I1_OFFSET | Offset
 * applied to ADC I1 measurement [-32768, 32767]. Default: 0. 36   | ADC_I2_OFFSET              |
 * Offset applied to ADC I2 measurement [-32768, 32767]. Default: 0. 37   | ADC_I3_OFFSET | Offset
 * applied to ADC I3 measurement [-32768, 32767]. Default: 0. 38   | ADC_I0                     |
 * Scaled and offset compensated ADC I0 measurement [-32768, 32767]. Read-only. 39   | ADC_I1 |
 * Scaled and offset compensated ADC I1 measurement [-32768, 32767]. Read-only. 40   | ADC_I2 |
 * Scaled and offset compensated ADC I2 measurement [-32768, 32767]. Read-only. 41   | ADC_I3 |
 * Scaled and offset compensated ADC I3 measurement [-32768, 32767]. Read-only.
 */
#define ADC_CONFIG_LIST(X)                                                                         \
  X(ADC_SHUNT_TYPE, 12,                                                                            \
    /*!< Shunt type for ADC measurements. See AdcShuntType enum. Default: 4 (BOTTOM_SHUNTS). */)   \
  ...
  X(CSA_GAIN_ADC_I3, 18,                                                                           \
    /*!< Current sense amplifier gain for ADC I3. See CsaGain enum. Default: 1 (GAIN_10X). */)     \
  ...
  X(PHASE_UX1_ADC_MAPPING, 22,                                                                     \
    /*!< Mapping ADC to UX1. See AdcMapping enum. Default: 0 (ADC_I0). */)                         \
  X(PHASE_VX2_ADC_MAPPING, 23,                                                                     \
    /*!< Mapping ADC to VX2. See AdcMapping enum. Default: 1 (ADC_I1). */)                         \
  X(PHASE_WY1_ADC_MAPPING, 24,                                                                     \
    /*!< Mapping ADC to WY1. See AdcMapping enum. Default: 2 (ADC_I2). */)                         \
  X(PHASE_Y2_ADC_MAPPING, 25,                                                                      \
    /*!< Mapping ADC to Y2. See AdcMapping enum. Default: 3 (ADC_I3). */)                          \
  ...
  X(ADC_I0_INVERTED, 30,                                                                           \
    /*!< Invert the reading of ADC I0. 0: NOT_INVERTED, 1: INVERTED. Default: 1. */)               \
  X(ADC_I1_INVERTED, 31,                                                                           \
    /*!< Invert the reading of ADC I1. 0: NOT_INVERTED, 1: INVERTED. Default: 1. */)               \
  X(ADC_I2_INVERTED, 32,                                                                           \
    /*!< Invert the reading of ADC I2. 0: NOT_INVERTED, 1: INVERTED. Default: 1. */)               \
  X(ADC_I3_INVERTED, 33,                                                                           \
    /*!< Invert the reading of ADC I3. 0: NOT_INVERTED, 1: INVERTED. Default: 1. */)               \
  ...
  X(ADC_I0, 38,                                                                                    \
    /*!< Scaled and offset compensated ADC I0 measurement [-32768, 32767]. Read-only. */)          \
  X(ADC_I1, 39,                                                                                    \
    /*!< Scaled and offset compensated ADC I1 measurement [-32768, 32767]. Read-only. */)          \
  X(ADC_I2, 40,                                                                                    \
    /*!< Scaled and offset compensated ADC I2 measurement [-32768, 32767]. Read-only. */)          \
  X(ADC_I3, 41,                                                                                    \
    /*!< Scaled and offset compensated ADC I3 measurement [-32768, 32767]. Read-only. */)
 ...
 *  NUMBER | NAME                          | DESCRIPTION
 *  ------ | ----------------------------- |
 * ----------------------------------------------------------------- 89  | ABN_1_PHI_E | Phi_e
 * calculated from ABN feedback [-32768, 32767]. Read-only. 90  | ABN_1_STEPS                   |
 * ABN encoder steps per rotation (CPR) [0, 16777215]. Default: 65536. 91  | ABN_1_DIRECTION | ABN
 * encoder rotation direction. 0: NOT_INVERTED, 1: INVERTED. Default: 0. 92  | ABN_1_INIT_METHOD |
 * ABN initialization method. See AbnInitMethod enum. Default: 0. 93  | ABN_1_INIT_STATE | ABN
 * initialization state. See AbnInitState enum. Read-only. 94  | ABN_1_INIT_DELAY              |
 * Delay for forced phi_e initialization [1000, 10000 ms]. Default: 1000. 95  | ABN_1_INIT_VELOCITY
 * | Init velocity for N-channel offset [-200000, 200000]. Default: 5. 96  |
 * ABN_1_N_CHANNEL_PHI_E_OFFSET  | Offset between phi_e zero and ABN index pulse [-32768, 32767].
 * Default: 0. 97  | ABN_1_N_CHANNEL_INVERTED      | ABN N-channel inversion. 0: ACTIVE_HIGH, 1:
 * ACTIVE_LOW. Default: 0. 98  | ABN_1_N_CHANNEL_FILTERING     | ABN N-channel filtering. See
 * AbnNChannelFiltering enum. Default: 0. 99  | ABN_1_CLEAR_ON_NEXT_NULL      | Clear position on
 * next N-channel event. 0: DISABLED, 1: ENABLED. Default: 0. 100  | ABN_1_VALUE                   |
 * Raw ABN encoder counter value [0, 16777215]. Read-only. 74  | HALL_PHI_E                    |
 * Phi_e calculated from Hall feedback [-32768, 32767]. Read-only. 75  | HALL_SECTOR_OFFSET | Hall
 * sector offset. See HallSectorOffset enum. Default: 0. 76  | HALL_FILTER_LENGTH            | Hall
 * signal filter length [0, 255]. Default: 0. 77  | HALL_POSITION_0_OFFSET        | Hall offset for
 * 0-degree position [-32768, 32767]. Default: 0. 78  | HALL_POSITION_60_OFFSET       | Hall offset
 * for 60-degree position [-32768, 32767]. Default: 10922. 79  | HALL_POSITION_120_OFFSET      |
 * Hall offset for 120-degree position [-32768, 32767]. Default: 21845. 80  |
 * HALL_POSITION_180_OFFSET      | Hall offset for 180-degree position [-32768, 32767]. Default:
 * -32768. 81  | HALL_POSITION_240_OFFSET      | Hall offset for 240-degree position [-32768,
 * 32767]. Default: -21846. 82  | HALL_POSITION_300_OFFSET      | Hall offset for 300-degree
 * position [-32768, 32767]. Default: -10923. 83  | HALL_INVERT_DIRECTION         | Invert Hall
 * angle direction. 0: NOT_INVERTED, 1: INVERTED. Default: 0. 84  | HALL_EXTRAPOLATION_ENABLE     |
 * Enable Hall extrapolation. 0: DISABLED, 1: ENABLED. Default: 0. 85  | HALL_PHI_E_OFFSET | Hall
 * sensor mounting tolerance compensation [-32768, 32767]. Default: 0. 181  |
 * SPI_ENCODER_CS_SETTLE_DELAY_TIME | CS settle delay time [0, 6375 ns]. Default: 0. 182  |
 * SPI_ENCODER_CS_IDLE_DELAY_TIME   | CS idle delay time between frames [0, 102 us]. Default: 0. 183
 * | SPI_ENCODER_MAIN_TRANSFER_CMD_SIZE | Size of first SPI transfer frame [1, 16]. Default: 1. 184
 * | SPI_ENCODER_SECONDARY_TRANSFER_CMD_SIZE | Size of optional secondary SPI transfer [0, 15].
 * Default: 0. 185  | SPI_ENCODER_TRANSFER_DATA_3_0   | Transmit data and read received data (bytes
 * 0-3). Default: 0. 186  | SPI_ENCODER_TRANSFER_DATA_7_4   | Transmit data and read received data
 * (bytes 4-7). Default: 0. 187  | SPI_ENCODER_TRANSFER_DATA_11_8  | Transmit data and read received
 * data (bytes 8-11). Default: 0. 188  | SPI_ENCODER_TRANSFER_DATA_15_12 | Transmit data and read
 * received data (bytes 12-15). Default: 0. 189  | SPI_ENCODER_TRANSFER            | SPI interface
 * control. See SpiEncoderTransfer enum. Default: 0. 190  | SPI_ENCODER_POSITION_COUNTER_MASK | Mask
 * to extract position from received data [0, 4294967295]. Default: 0. 191  |
 * SPI_ENCODER_POSITION_COUNTER_SHIFT | Right bit shift for position value before mask [0, 127].
 * Default: 0. 192  | SPI_ENCODER_POSITION_COUNTER_VALUE | Actual SPI encoder position value [0,
 * 4294967295]. Read-only. 193  | SPI_ENCODER_COMMUTATION_ANGLE   | Actual absolute encoder angle
 * value [-32768, 32767]. Read-only. 194  | SPI_ENCODER_INITIALIZATION_METHOD | Encoder
 * initialization method. See SpiInitMethod enum. Default: 0. 195  | SPI_ENCODER_DIRECTION | SPI
 * encoder direction. 0: NOT_INVERTED, 1: INVERTED. Default: 0. 196  | SPI_ENCODER_OFFSET | Internal
 * commutation offset [0, 4294967295]. Default: 0. 197  | SPI_LUT_CORRECTION_ENABLE       | Enable
 * lookup table correction. 0: DISABLED, 1: ENABLED. Default: 0. 198  | SPI_LUT_ADDRESS_SELECT |
 * Address to read/write in lookup table [0, 255]. Default: 0. 199  | SPI_LUT_DATA | Data to
 * read/write to lookup table address [-128, 127]. Default: 0. 201  | SPI_LUT_COMMON_SHIFT_FACTOR |
 * LUT entries are multiplied with 2^SHIFT_FACTOR [-128, 127]. Default: 0. 174  | ABN_2_STEPS | ABN
 * 2 encoder steps per rotation (CPR) [0, 16777215]. Default: 1024. 175  | ABN_2_DIRECTION | ABN 2
 * encoder rotation direction. 0: NORMAL, 1: INVERTED. Default: 0. 176  | ABN_2_GEAR_RATIO | ABN 2
 * encoder gear ratio [1, 255]. Default: 1. 177  | ABN_2_ENABLE                    | Enable ABN 2
 * encoder. 0: DISABLED, 1: ENABLED. Default: 0. 178  | ABN_2_VALUE                     | Raw ABN 2
 * encoder counter value [0, 4294967295]. Read-only.
 */
#define FEEDBACK_SENSOR_CONFIG_LIST(X)                                                             \
  ...
  X(ABN_1_DIRECTION, 91,                                                                           \
    /*!< ABN encoder rotation direction. 0: NOT_INVERTED, 1: INVERTED. Default: 0. */)             \
  ...
  X(ABN_1_INIT_DELAY, 94,                                                                          \
    /*!< Delay for forced phi_e initialization [1000, 10000 ms]. Default: 1000. */)                \
  X(ABN_1_INIT_VELOCITY, 95,                                                                       \
    /*!< Init velocity for N-channel offset [-200000, 200000]. Default: 5. */)                     \
  X(ABN_1_N_CHANNEL_PHI_E_OFFSET, 96,                                                              \
    /*!< Offset between phi_e zero and ABN index pulse [-32768, 32767]. Default: 0. */)            \
  X(ABN_1_N_CHANNEL_INVERTED, 97,                                                                  \
    /*!< ABN N-channel inversion. 0: ACTIVE_HIGH, 1: ACTIVE_LOW. Default: 0. */)                   \
  X(ABN_1_N_CHANNEL_FILTERING, 98,                                                                 \
    /*!< ABN N-channel filtering. See AbnNChannelFiltering enum. Default: 0. */)                   \
  X(ABN_1_CLEAR_ON_NEXT_NULL, 99,                                                                  \
    /*!< Clear position on next N-channel event. 0: DISABLED, 1: ENABLED. Default: 0. */)          \
  ...
  X(HALL_POSITION_0_OFFSET, 77,                                                                    \
    /*!< Hall offset for 0-degree position [-32768, 32767]. Default: 0. */)                        \
  X(HALL_POSITION_60_OFFSET, 78,                                                                   \
    /*!< Hall offset for 60-degree position [-32768, 32767]. Default: 10922. */)                   \
  X(HALL_POSITION_120_OFFSET, 79,                                                                  \
    /*!< Hall offset for 120-degree position [-32768, 32767]. Default: 21845. */)                  \
  X(HALL_POSITION_180_OFFSET, 80,                                                                  \
    /*!< Hall offset for 180-degree position [-32768, 32767]. Default: -32768. */)                 \
  X(HALL_POSITION_240_OFFSET, 81,                                                                  \
    /*!< Hall offset for 240-degree position [-32768, 32767]. Default: -21846. */)                 \
  X(HALL_POSITION_300_OFFSET, 82,                                                                  \
    /*!< Hall offset for 300-degree position [-32768, 32767]. Default: -10923. */)                 \
  X(HALL_INVERT_DIRECTION, 83,                                                                     \
    /*!< Invert Hall angle direction. 0: NOT_INVERTED, 1: INVERTED. Default: 0. */)                \
  X(HALL_EXTRAPOLATION_ENABLE, 84,                                                                 \
    /*!< Enable Hall extrapolation. 0: DISABLED, 1: ENABLED. Default: 0. */)                       \
  X(HALL_PHI_E_OFFSET, 85,                                                                         \
    /*!< Hall sensor mounting tolerance compensation [-32768, 32767]. Default: 0. */)              \
  X(SPI_ENCODER_CS_SETTLE_DELAY_TIME, 181, /*!< CS settle delay time [0, 6375 ns]. Default: 0. */) \
  X(SPI_ENCODER_CS_IDLE_DELAY_TIME, 182,                                                           \
    /*!< CS idle delay time between frames [0, 102 us]. Default: 0. */)                            \
  X(SPI_ENCODER_MAIN_TRANSFER_CMD_SIZE, 183,                                                       \
    /*!< Size of first SPI transfer frame [1, 16]. Default: 1. */)                                 \
  X(SPI_ENCODER_SECONDARY_TRANSFER_CMD_SIZE, 184,                                                  \
    /*!< Size of optional secondary SPI transfer [0, 15]. Default: 0. */)                          \
  X(SPI_ENCODER_TRANSFER_DATA_3_0, 185,                                                            \
    /*!< Transmit data and read received data (bytes 0-3). Default: 0. */)                         \
  X(SPI_ENCODER_TRANSFER_DATA_7_4, 186,                                                            \
    /*!< Transmit data and read received data (bytes 4-7). Default: 0. */)                         \
  X(SPI_ENCODER_TRANSFER_DATA_11_8, 187,                                                           \
    /*!< Transmit data and read received data (bytes 8-11). Default: 0. */)                        \
  X(SPI_ENCODER_TRANSFER_DATA_15_12, 188,                                                          \
    /*!< Transmit data and read received data (bytes 12-15). Default: 0. */)                       \
  X(SPI_ENCODER_TRANSFER, 189,                                                                     \
    /*!< SPI interface control. See SpiEncoderTransfer enum. Default: 0. */)                       \
  X(SPI_ENCODER_POSITION_COUNTER_MASK, 190,                                                        \
    /*!< Mask to extract position from received data [0, 4294967295]. Default: 0. */)              \
  X(SPI_ENCODER_POSITION_COUNTER_SHIFT, 191,                                                       \
    /*!< Right bit shift for position value before mask [0, 127]. Default: 0. */)                  \
  X(SPI_ENCODER_POSITION_COUNTER_VALUE, 192,                                                       \
    /*!< Actual SPI encoder position value [0, 4294967295]. Read-only. */)                         \
  X(SPI_ENCODER_COMMUTATION_ANGLE, 193,                                                            \
    /*!< Actual absolute encoder angle value [-32768, 32767]. Read-only. */)                       \
  X(SPI_ENCODER_INITIALIZATION_METHOD, 194,                                                        \
    /*!< Encoder initialization method. See SpiInitMethod enum. Default: 0. */)                    \
  X(SPI_ENCODER_DIRECTION, 195,                                                                    \
    /*!< SPI encoder direction. 0: NOT_INVERTED, 1: INVERTED. Default: 0. */)                      \
  X(SPI_ENCODER_OFFSET, 196, /*!< Internal commutation offset [0, 4294967295]. Default: 0. */)     \
  X(SPI_LUT_CORRECTION_ENABLE, 197,                                                                \
    /*!< Enable lookup table correction. 0: DISABLED, 1: ENABLED. Default: 0. */)                  \
  X(SPI_LUT_ADDRESS_SELECT, 198,                                                                   \
    /*!< Address to read/write in lookup table [0, 255]. Default: 0. */)                           \
  X(SPI_LUT_DATA, 199,                                                                             \
    /*!< Data to read/write to lookup table address [-128, 127]. Default: 0. */)                   \
  X(SPI_LUT_COMMON_SHIFT_FACTOR, 201,                                                              \
    /*!< LUT entries are multiplied with 2^SHIFT_FACTOR [-128, 127]. Default: 0. */)               \
  X(ABN_2_STEPS, 174,                                                                              \
    /*!< ABN 2 encoder steps per rotation (CPR) [0, 16777215]. Default: 1024. */)                  \
  X(ABN_2_DIRECTION, 175,                                                                          \
    /*!< ABN 2 encoder rotation direction. 0: NORMAL, 1: INVERTED. Default: 0. */)                 \
...
inline const char *to_string(FeedbackSensorConfig config) {
  switch (config) {
#define X(NAME, VALUE, DOC)                                                                        \
  case FeedbackSensorConfig::NAME:                                                                 \
    return #NAME;
    FEEDBACK_SENSOR_CONFIG_LIST(X)
#undef X
  default:
...
inline const char *to_string(AbnNChannelFiltering filtering) {
  switch (filtering) {
#define X(NAME, VALUE, DOC)                                                                        \
  case AbnNChannelFiltering::NAME:                                                                 \
    return #NAME;
    ABN_N_CHANNEL_FILTERING_LIST(X)
#undef X
  default:
...
#define SPI_INIT_METHOD_LIST(X)                                                                    \
  X(FORCED_PHI_E_ZERO_WITH_ACTIVE_SWING, 0,                                                        \
    /*!< Force rotor into PHI_E zero with active swing. */)                                        \
 ...
 *  NUMBER | NAME                              | DESCRIPTION
 *  ------ | --------------------------------- |
 * ----------------------------------------------------------------- 6   | MAX_TORQUE | Maximum
 * motor torque [mA]. 0...65535. Default: 2000. RWE 7   | MAX_FLUX                          |
 * Maximum motor flux [mA]. 0...65535. Default: 2000. RWE 104   | TARGET_TORQUE | Target torque
 * [mA]. Write to activate torque regulation. -32768...32767. Default: 0. RW 105   | ACTUAL_TORQUE
 * | Actual motor torque [mA]. -32767...32768. Default: 0. R 106   | TARGET_FLUX | Target flux [mA].
 * -10000...10000. Default: 0. RW 107   | ACTUAL_FLUX                       | Actual motor flux
 * [mA]. -2147483648...2147483647. Default: 0. R 108   | TORQUE_OFFSET                     | Offset
 * applied to torque value [mA]. -4700...4700. Default: 0. RW 109   | TORQUE_P | P parameter for
 * torque PI regulator. 0...32767. Default: 50. RWE 110   | TORQUE_I                          | I
 * parameter for torque PI regulator. 0...32767. Default: 100. RWE 111   | FLUX_P | P parameter for
 * flux PI regulator (if separated). 0...32767. Default: 50. RWE 112   | FLUX_I | I parameter for
 * flux PI regulator (if separated). 0...32767. Default: 100. RWE 113   |
 * SEPARATE_TORQUE_FLUX_PI_PARAMETERS| Enable separate PI values for torque/flux. 0: COMBINED, 1:
 * SEPARATED. Default: 0. RWE 114   | CURRENT_NORM_P                    | P normalization format for
 * current PI. 0: SHIFT_8_BIT, 1: SHIFT_16_BIT. Default: 0. RWE 115   | CURRENT_NORM_I | I
 * normalization format for current PI. 0: SHIFT_8_BIT, 1: SHIFT_16_BIT. Default: 1. RWE 116   |
 * TORQUE_PI_ERROR                   | Torque PI regulator error. -2147483648...2147483647. Default:
 * 0. R 117   | FLUX_PI_ERROR                     | Flux PI regulator error.
 * -2147483648...2147483647. Default: 0. R 118   | TORQUE_PI_INTEGRATOR              | Integrated
 * error of torque PI. -2147483648...2147483647. Default: 0. R 119   | FLUX_PI_INTEGRATOR |
 * Integrated error of flux PI. -2147483648...2147483647. Default: 0. R 120   | FLUX_OFFSET | Offset
 * applied to flux value [mA]. -4700...4700. Default: 0. RW 308   | FIELDWEAKENING_I | I parameter
 * for field weakening controller. 0...32767. Default: 0. RWE 310   |
 * FIELDWEAKENING_VOLTAGE_THRESHOLD  | Max voltage for field weakening. 0...32767. Default: 32767.
 * RWE
 */
#define TORQUE_FLUX_CONTROL_LIST(X)                                                                \
  ...
  X(FLUX_P, 111,                                                                                   \
    /*!< P parameter for flux PI regulator (if separated). 0...32767. Default: 50. RWE */)         \
  X(FLUX_I, 112,                                                                                   \
    /*!< I parameter for flux PI regulator (if separated). 0...32767. Default: 100. RWE */)        \
  X(SEPARATE_TORQUE_FLUX_PI_PARAMETERS, 113,                                                       \
    /*!< Enable separate PI values for torque/flux. 0: COMBINED, 1: SEPARATED. Default: 0. RWE */) \
  ...
  X(TORQUE_PI_ERROR, 116,                                                                          \
    /*!< Torque PI regulator error. -2147483648...2147483647. Default: 0. R */)                    \
  X(FLUX_PI_ERROR, 117, /*!< Flux PI regulator error. -2147483648...2147483647. Default: 0. R */)  \
  X(TORQUE_PI_INTEGRATOR, 118,                                                                     \
    /*!< Integrated error of torque PI. -2147483648...2147483647. Default: 0. R */)                \
  X(FLUX_PI_INTEGRATOR, 119,                                                                       \
    /*!< Integrated error of flux PI. -2147483648...2147483647. Default: 0. R */)                  \
  X(FLUX_OFFSET, 120, /*!< Offset applied to flux value [mA]. -4700...4700. Default: 0. RW */)     \
  X(FIELDWEAKENING_I, 308,                                                                         \
    /*!< I parameter for field weakening controller. 0...32767. Default: 0. RWE */)                \
  X(FIELDWEAKENING_VOLTAGE_THRESHOLD, 310,                                                         \
    /*!< Max voltage for field weakening. 0...32767. Default: 32767. RWE */)
 ...
 *  NUMBER | NAME                     | DESCRIPTION
 *  ------ | ------------------------ |
 * ----------------------------------------------------------------- 0   | TORQUE_FLUX_PI_COMBINED
 * | Use same PI parameters for torque and flux. 1   | TORQUE_FLUX_PI_SEPARATED | Use separate PI
 * parameters for torque and flux.
 */
...
inline const char *to_string(TorqueFluxPiSeparation separation) {
  switch (separation) {
#define X(NAME, VALUE, DOC)                                                                        \
  case TorqueFluxPiSeparation::NAME:                                                               \
    return #NAME;
    TORQUE_FLUX_PI_SEPARATION_LIST(X)
#undef X
  default:
...
inline const char *to_string(CurrentPiNormalization norm) {
  switch (norm) {
#define X(NAME, VALUE, DOC)                                                                        \
  case CurrentPiNormalization::NAME:                                                               \
    return #NAME;
    CURRENT_PI_NORMALIZATION_LIST(X)
#undef X
  default:
 ...
 *  ------ | ----------------------------- |
 * ----------------------------------------------------------------- 123   |
 * VELOCITY_SENSOR_SELECTION     | Feedback source for velocity PI regulator. See
 * VelocitySensorSelection. Default: 0 (SAME_AS_COMMUTATION). RWE 124   | TARGET_VELOCITY | Target
 * velocity value. Write to activate velocity regulation. -134217728...134217727. Default: 0. RW 125
 * | ACTUAL_VELOCITY               | Actual velocity value. -2147483648...2147483647. Default: 0. R
 *   126   | VELOCITY_OFFSET               | Offset applied to velocity value. -200000...200000.
 * Default: 0. RW 127   | VELOCITY_P                    | P parameter for velocity PI regulator.
 * 0...32767. Default: 800. RWE 128   | VELOCITY_I                    | I parameter for velocity PI
 * regulator. 0...32767. Default: 1. RWE 129   | VELOCITY_NORM_P               | P normalization for
 * velocity PI. See VelocityPiNorm. Default: 2. RWE 130   | VELOCITY_NORM_I               | I
 * normalization for velocity PI. See VelocityPiNorm. Default: 2. RWE 131   | VELOCITY_PI_INTEGRATOR
 * | Integrated error of velocity PI regulator. -2147483648...2147483647. Default: 0. R 132   |
 * VELOCITY_PI_ERROR             | Velocity PI regulator error. -2147483648...2147483647. Default:
 * 0. R 133   | VELOCITY_SCALING_FACTOR       | Scaling factor for velocity to real-world
 * units. 1...2047. Default: 1. RWE 135   | VELOCITY_LOOP_DOWNSAMPLING    | Downsampling factor for
 * velocity controller. 0...127. Default: 5. RWE 137   | VELOCITY_METER_SWITCH_THRESHOLD | Threshold
 * for switching from period to frequency velocity meter. 0...134217727. Default: 2000. RWE 138   |
 * VELOCITY_METER_SWITCH_HYSTERESIS | Hysteresis for switching back to period meter. 0...65535.
 * Default: 500. RWE 139   | VELOCITY_METER_MODE           | Currently used velocity meter mode. See
 * VelocityMeterMode. Default: 0. R 45   | OPENLOOP_ANGLE                | Phi_e calculated by
 * ramper hardware (openloop modes). -32768...32767. Default: 0. R 46   | OPENLOOP_CURRENT |
 * Openloop current applied in openloop, current mode [mA]. 0...65535. Default: 1000. RWE 47   |
 * OPENLOOP_VOLTAGE              | Openloop voltage applied in openloop, voltage mode. 0...16383.
 * Default: 0. RWE 50   | ACCELERATION_FF_GAIN          | Gain for acceleration feedforward.
 * 0...65535. Default: 8. RWE 51   | ACCELERATION_FF_SHIFT         | Shift for acceleration
 * feedforward. See AccelerationFfShift. Default: 4. RWE 52   | RAMP_ENABLE                   |
 * Enable acceleration/deceleration ramps. 0: DISABLED, 1: ENABLED. Default: 0. RWE 53   |
 * DIRECT_VELOCITY_MODE          | Direct velocity control mode. 0: DISABLED, 1: ENABLED.
 * Default: 1. RWE 54   | RAMP_AMAX                     | Max acceleration (top part of
 * ramp). 1...8388607. Default: 1000. RWE 55   | RAMP_A1                       | First acceleration
 * in ramp. 1...8388607. Default: 8000. RWE 56   | RAMP_A2                       | Second
 * acceleration in ramp. 1...8388607. Default: 4000. RWE 57   | RAMP_DMAX                     | Max
 * deceleration (top part of ramp). 1...8388607. Default: 1000. RWE 58   | RAMP_D1 | Second
 * deceleration in ramp. 1...8388607. Default: 8000. RWE 59   | RAMP_D2                       |
 * First deceleration in ramp. 1...8388607. Default: 8000. RWE 60   | RAMP_VMAX | Max velocity of
 * ramp. 0...134217727. Default: 134217727. RWE 61   | RAMP_V1                       | Velocity
 * threshold for A1/D1 to A2/D2. 0...134217727. Default: 0. RWE 62   | RAMP_V2 | Velocity threshold
 * for A2/D2 to AMAX/DMAX. 0...134217727. Default: 0. RWE 63   | RAMP_VSTART                   |
 * Start velocity of ramp. 0...8388607. Default: 0. RWE 64   | RAMP_VSTOP                    | Stop
 * velocity of ramp. 1...8388607. Default: 1. RWE 65   | RAMP_TVMAX                    | Min time at
 * VMAX before deceleration. 0...65535. Default: 0. RWE 66   | RAMP_TZEROWAIT                | Wait
 * time at end of ramp. 0...65535. Default: 0. RWE 67   | ACCELERATION_FEEDFORWARD_ENABLE | Enable
 * acceleration feedforward. 0: DISABLED, 1: ENABLED. Default: 0. RWE 68   |
 * VELOCITY_FEEDFORWARD_ENABLE   | Enable velocity feedforward. 0: DISABLED, 1: ENABLED. Default: 0.
 * RWE 69   | RAMP_VELOCITY                 | Target velocity calculated by ramp controller.
 * -134217727...134217727. Default: 0. R 70   | RAMP_VELOCITY_ERROR            | Error of ramp
 * velocity controller. -134217727...134217727. Default: 0. R
 */
#define VELOCITY_CONTROL_LIST(X)                                                                   \
  ...
  X(VELOCITY_OFFSET, 126,                                                                          \
    /*!< Offset applied to velocity value. -200000...200000. Default: 0. RW */)                    \
  ...
  X(VELOCITY_NORM_P, 129,                                                                          \
    /*!< P normalization for velocity PI. See VelocityPiNorm. Default: 2. RWE */)                  \
  X(VELOCITY_NORM_I, 130,                                                                          \
    /*!< I normalization for velocity PI. See VelocityPiNorm. Default: 2. RWE */)                  \
  X(VELOCITY_PI_INTEGRATOR, 131,                                                                   \
    /*!< Integrated error of velocity PI regulator. -2147483648...2147483647. Default: 0. R */)    \
  X(VELOCITY_PI_ERROR, 132,                                                                        \
    /*!< Velocity PI regulator error. -2147483648...2147483647. Default: 0. R */)                  \
  X(VELOCITY_SCALING_FACTOR, 133,                                                                  \
    /*!< Scaling factor for velocity to real-world units. 1...2047. Default: 1. RWE */)            \
  X(VELOCITY_LOOP_DOWNSAMPLING, 135,                                                               \
    /*!< Downsampling factor for velocity controller. 0...127. Default: 5. RWE */)                 \
  ...
  X(VELOCITY_METER_SWITCH_HYSTERESIS, 138,                                                         \
    /*!< Hysteresis for switching back to period meter. 0...65535. Default: 500. RWE */)           \
  X(VELOCITY_METER_MODE, 139,                                                                      \
    /*!< Currently used velocity meter mode. See VelocityMeterMode. Default: 0. R */)              \
  X(OPENLOOP_ANGLE, 45,                                                                            \
    /*!< Phi_e calculated by ramper hardware (openloop modes). -32768...32767. Default: 0. R */)   \
  X(OPENLOOP_CURRENT,                    46, /*!< Openloop current applied in openloop, current mode [mA]. 0...65535. Default: 1000. RWE */)                                                                                                \
  X(OPENLOOP_VOLTAGE, 47,                                                                          \
    /*!< Openloop voltage applied in openloop, voltage mode. 0...16383. Default: 0. RWE */)        \
  X(ACCELERATION_FF_GAIN, 50,                                                                      \
    /*!< Gain for acceleration feedforward. 0...65535. Default: 8. RWE */)                         \
  X(ACCELERATION_FF_SHIFT, 51,                                                                     \
    /*!< Shift for acceleration feedforward. See AccelerationFfShift. Default: 4. RWE */)          \
  X(RAMP_ENABLE, 52,                                                                               \
    /*!< Enable acceleration/deceleration ramps. 0: DISABLED, 1: ENABLED. Default: 0. RWE */)      \
  X(DIRECT_VELOCITY_MODE, 53,                                                                      \
    /*!< Direct velocity control mode. 0: DISABLED, 1: ENABLED. Default: 1. RWE */)                \
  ...
  X(RAMP_V2, 62,                                                                                   \
    /*!< Velocity threshold for A2/D2 to AMAX/DMAX. 0...134217727. Default: 0. RWE */)             \
  ...
  X(ACCELERATION_FEEDFORWARD_ENABLE, 67,                                                           \
    /*!< Enable acceleration feedforward. 0: DISABLED, 1: ENABLED. Default: 0. RWE */)             \
  X(VELOCITY_FEEDFORWARD_ENABLE, 68,                                                               \
    /*!< Enable velocity feedforward. 0: DISABLED, 1: ENABLED. Default: 0. RWE */)                 \
  X(RAMP_VELOCITY, 69,                                                                             \
    /*!< Target velocity calculated by ramp controller. -134217727...134217727. Default: 0. R */)  \
...
inline const char *to_string(VelocitySensorSelection selection) {
  switch (selection) {
#define X(NAME, VALUE, DOC)                                                                        \
  case VelocitySensorSelection::NAME:                                                              \
    return #NAME;
    VELOCITY_SENSOR_SELECTION_LIST(X)
#undef X
  default:
 ...
 *  ------ | --------------------- |
 * ----------------------------------------------------------------- 142   |
 * POSITION_SENSOR_SELECTION | Feedback source for position PI regulator. See
 * PositionSensorSelection. Default: 0 (SAME_AS_COMMUTATION). RWE 143   | TARGET_POSITION | Target
 * position value. Write to activate position regulation. -2147483648...2147483647. Default: 0. RW
 *   144   | ACTUAL_POSITION           | Actual position value. -2147483648...2147483647. Default:
 * 0. RW 145   | POSITION_SCALING_FACTOR   | Scaling factor for position to real-world units.
 * 1024...65535. Default: 1024. RWE 146   | POSITION_P                | P parameter for position PI
 * regulator. 0...32767. Default: 5. RWE 147   | POSITION_I                | I parameter for
 * position PI regulator. 0...32767. Default: 0. RWE 148   | POSITION_NORM_P           | P
 * normalization for position PI. See PositionPiNorm. Default: 1. RWE 149   | POSITION_NORM_I | I
 * normalization for position PI. See PositionPiNorm. Default: 1. RWE 150   | POSITION_PI_INTEGRATOR
 * | Integrated error of position PI regulator. -2147483648...2147483647. Default: 0. R 151   |
 * POSITION_PI_ERROR         | Error of position PI regulator. -2147483648...2147483647. Default: 0.
 * R 153   | POSITION_LOOP_DOWNSAMPLING| Downsampling factor for position controller. 0...127.
 * Default: 0. RWE 154   | LATCH_POSITION            | Position switch latched.
 * -2147483648...2147483647. Default: 0. R 155   | POSITION_LIMIT_LOW        | Position limit low.
 * -2147483648...2147483647. Default: -2147483648. RWE 156   | POSITION_LIMIT_HIGH       | Position
 * limit high. -2147483648...2147483647. Default: 2147483647. RWE 157   |
 * POSITION_REACHED_THRESHOLD| Deviation between target and actual position below which the position
 * reached flag goes active and latches. If a new target position is set the flag is reset.
 * 0...2147483647. Default: 0. RWE
 */
#define POSITION_CONTROL_LIST(X)                                                                   \
  ...
  X(POSITION_SCALING_FACTOR, 145,                                                                  \
    /*!< Scaling factor for position to real-world units. 1024...65535. Default: 1024. RWE */)     \
  ...
  X(POSITION_NORM_P, 148,                                                                          \
    /*!< P normalization for position PI. See PositionPiNorm. Default: 1. RWE */)                  \
  X(POSITION_NORM_I, 149,                                                                          \
    /*!< I normalization for position PI. See PositionPiNorm. Default: 1. RWE */)                  \
  X(POSITION_PI_INTEGRATOR, 150,                                                                   \
    /*!< Integrated error of position PI regulator. -2147483648...2147483647. Default: 0. R */)    \
  X(POSITION_PI_ERROR, 151,                                                                        \
    /*!< Error of position PI regulator. -2147483648...2147483647. Default: 0. R */)               \
  X(POSITION_LOOP_DOWNSAMPLING, 153,                                                               \
    /*!< Downsampling factor for position controller. 0...127. Default: 0. RWE */)                 \
  X(LATCH_POSITION, 154, /*!< Position switch latched. -2147483648...2147483647. Default: 0. R */) \
  X(POSITION_LIMIT_LOW, 155,                                                                       \
    /*!< Position limit low. -2147483648...2147483647. Default: -2147483648. RWE */)               \
  X(POSITION_LIMIT_HIGH, 156,                                                                      \
    /*!< Position limit high. -2147483648...2147483647. Default: 2147483647. RWE */)               \
...
inline const char *to_string(PositionSensorSelection selection) {
  switch (selection) {
#define X(NAME, VALUE, DOC)                                                                        \
  case PositionSensorSelection::NAME:                                                              \
    return #NAME;
    POSITION_SENSOR_SELECTION_LIST(X)
#undef X
  default:
 ...
 *  ------ | ----------------------------- |
 * ----------------------------------------------------------------- 134   |
 * STOP_ON_VELOCITY_DEVIATION    | Max velocity deviation before stop event [0...200000]. Default:
 * 0. RW 152   | STOP_ON_POSITION_DEVIATION    | Max position deviation before stop event
 * [0...2147483647]. Default: 0. RWE 154   | LATCH_POSITION                | Latched position at
 * switch event [-2147483648...2147483647]. Default: 0. R 161   | REFERENCE_SWITCH_ENABLE       |
 * Bitwise enable for stopping on reference switch. See ReferenceSwitchEnable. Default: 0. RWE 162
 * | REFERENCE_SWITCH_POLARITY_AND_SWAP | Bitwise config for switch polarity/swap. See
 * ReferenceSwitchPolaritySwap. Default: 0. RWE 163   | REFERENCE_SWITCH_LATCH_SETTINGS    | Bitwise
 * config for latch behavior. See ReferenceSwitchLatchSettings. Default: 0. RWE 164   |
 * EVENT_STOP_SETTINGS           | Bitwise config for stop conditions. See EventStopSettings.
 * Default: 0. RWE
 */
#define RAMPER_STOP_CONFIG_LIST(X)                                                                 \
  X(STOP_ON_VELOCITY_DEVIATION, 134,                                                               \
    /*!< Max velocity deviation before stop event [0...200000]. Default: 0. RW */)                 \
  X(STOP_ON_POSITION_DEVIATION, 152,                                                               \
    /*!< Max position deviation before stop event [0...2147483647]. Default: 0. RWE */)            \
  ...
  X(REFERENCE_SWITCH_LATCH_SETTINGS, 163,                                                          \
    /*!< Bitwise config for latch behavior. See ReferenceSwitchLatchSettings. Default: 0. RWE */)  \
  X(EVENT_STOP_SETTINGS, 164,                                                                      \
    /*!< Bitwise config for stop conditions. See EventStopSettings. Default: 0. RWE */)
 ...
 *  ------ | --------------------- |
 * ----------------------------------------------------------------- 0   |
 * NO_STOP_ON_SWITCH_TRIGGERED | No stop on switch. 1   | STOP_ON_L             | Stop on left
 * switch. 2   | STOP_ON_R             | Stop on right switch. 3   | STOP_ON_R_AND_L       | Stop on
 * right and left switches. 4   | STOP_ON_H             | Stop on home switch. 5   | STOP_ON_H_AND_L
 * | Stop on home and left switches. 6   | STOP_ON_H_AND_R       | Stop on home and right switches.
...
inline const char *to_string(ReferenceSwitchEnable enable) {
  switch (enable) {
#define X(NAME, VALUE, DOC)                                                                        \
  case ReferenceSwitchEnable::NAME:                                                                \
    return #NAME;
    REFERENCE_SWITCH_ENABLE_LIST(X)
#undef X
  default:
 ...
 *  NUMBER | NAME                        | DESCRIPTION
 *  ------ | --------------------------- |
 * ----------------------------------------------------------------- 0   | NOT_SWAPPED_NOT_INVERTED
 * | No swapping or inversion. 1   | L_INVERTED                  | Left switch inverted. 2   |
 * R_INVERTED                  | Right switch inverted. 3   | R_AND_L_INVERTED            | Right
 * and left switches inverted. 4   | H_INVERTED                  | Home switch inverted. 5   |
 * H_AND_L_INVERTED            | Home and left switches inverted. 6   | H_AND_R_INVERTED | Home and
 * right switches inverted. 7   | H_R_AND_L_INVERTED          | Home, right, and left switches
 * inverted. 8   | L_R_SWAPPED_L_INVERTED      | Left and right switches swapped, left inverted. 9
 * | L_R_SWAPPED_R_INVERTED      | Left and right switches swapped, right inverted. 10   |
 * L_R_SWAPPED_R_AND_L_INVERTED| Left and right switches swapped, both inverted. 11   |
 * L_R_SWAPPED_H_INVERTED      | Left and right switches swapped, home inverted. 12   |
 * L_R_SWAPPED_H_AND_L_INVERTED| Left and right switches swapped, home and left inverted. 13   |
 * L_R_SWAPPED                 | Left and right switches swapped. 14   |
 * L_R_SWAPPED_H_AND_R_INVERTED| Left and right switches swapped, home and right inverted. 15   |
 * L_R_SWAPPED_H_R_AND_L_INVERTED | Left and right switches swapped, home, right, and left inverted.
 */
#define REFERENCE_SWITCH_POLARITY_SWAP_LIST(X)                                                     \
  ...
  X(L_R_SWAPPED_H_AND_L_INVERTED, 12,                                                              \
    /*!< Left and right switches swapped, home and left inverted. */)                              \
  X(L_R_SWAPPED, 13, /*!< Left and right switches swapped. */)                                     \
  X(L_R_SWAPPED_H_AND_R_INVERTED, 14,                                                              \
    /*!< Left and right switches swapped, home and right inverted. */)                             \
  X(L_R_SWAPPED_H_R_AND_L_INVERTED, 15,                                                            \
    /*!< Left and right switches swapped, home, right, and left inverted. */)
...
inline const char *to_string(ReferenceSwitchPolaritySwap config) {
  switch (config) {
#define X(NAME, VALUE, DOC)                                                                        \
  case ReferenceSwitchPolaritySwap::NAME:                                                          \
    return #NAME;
    REFERENCE_SWITCH_POLARITY_SWAP_LIST(X)
#undef X
  default:
 ...
 *  NUMBER | NAME                        | DESCRIPTION
 *  ------ | --------------------------- |
 * ----------------------------------------------------------------- 0   | NO_TRIGGER | No latch
 * triggered. 1   | L_R_RISING_EDGE             | Latch on rising edge of left/right switch. 2   |
 * L_R_FALLING_EDGE            | Latch on falling edge of left/right switch. 3   | L_R_BOTH_EDGES |
 * Latch on both edges of left/right switch. 4   | H_RISING_EDGE               | Latch on rising
 * edge of home switch. 5   | H_L_R_RISING_EDGE           | Latch on rising edge of home and
 * left/right switches. 6   | H_RISING_L_R_FALLING_EDGE   | Latch on rising edge of home and falling
 * edge of left/right switches. 7   | H_RISING_L_R_BOTH_EDGES     | Latch on rising edge of home and
 * both edges of left/right switches. 8   | H_FALLING_EDGE              | Latch on falling edge of
 * home switch. 9   | H_FALLING_L_R_RISING_EDGE   | Latch on falling edge of home and rising edge of
 * left/right switches. 10   | H_L_R_FALLING_EDGE          | Latch on falling edge of home and
 * left/right switches. 11   | H_FALLING_L_R_BOTH_EDGES    | Latch on falling edge of home and both
 * edges of left/right switches. 12   | H_BOTH_EDGES                | Latch on both edges of home
 * switch. 13   | H_BOTH_L_R_RISING_EDGE      | Latch on both edges of home and rising edge of
 * left/right switches. 14   | H_BOTH_L_R_FALLING_EDGE     | Latch on both edges of home and falling
 * edge of left/right switches. 15   | H_L_R_BOTH_EDGES            | Latch on both edges of home and
 * left/right switches.
 */
#define REFERENCE_SWITCH_LATCH_SETTINGS_LIST(X)                                                    \
  ...
  X(H_RISING_L_R_FALLING_EDGE, 6,                                                                  \
    /*!< Latch on rising edge of home and falling edge of left/right switches. */)                 \
  X(H_RISING_L_R_BOTH_EDGES, 7,                                                                    \
    /*!< Latch on rising edge of home and both edges of left/right switches. */)                   \
  X(H_FALLING_EDGE, 8, /*!< Latch on falling edge of home switch. */)                              \
  X(H_FALLING_L_R_RISING_EDGE, 9,                                                                  \
    /*!< Latch on falling edge of home and rising edge of left/right switches. */)                 \
  X(H_L_R_FALLING_EDGE, 10, /*!< Latch on falling edge of home and left/right switches. */)        \
  X(H_FALLING_L_R_BOTH_EDGES, 11,                                                                  \
    /*!< Latch on falling edge of home and both edges of left/right switches. */)                  \
  X(H_BOTH_EDGES, 12, /*!< Latch on both edges of home switch. */)                                 \
  X(H_BOTH_L_R_RISING_EDGE, 13,                                                                    \
    /*!< Latch on both edges of home and rising edge of left/right switches. */)                   \
  X(H_BOTH_L_R_FALLING_EDGE, 14,                                                                   \
    /*!< Latch on both edges of home and falling edge of left/right switches. */)                  \
...
inline const char *to_string(ReferenceSwitchLatchSettings setting) {
  switch (setting) {
#define X(NAME, VALUE, DOC)                                                                        \
  case ReferenceSwitchLatchSettings::NAME:                                                         \
    return #NAME;
    REFERENCE_SWITCH_LATCH_SETTINGS_LIST(X)
#undef X
  default:
 ...
 *  NUMBER | NAME                              | DESCRIPTION
 *  ------ | --------------------------------- |
 * ----------------------------------------------------------------- 0   | DO_HARD_STOP | Hard stop
 * on event. 1   | DO_SOFT_STOP                      | Soft stop (ramp down) on event. 2   |
 * STOP_ON_POS_DEVIATION             | Stop on position deviation. 3   |
 * STOP_ON_POS_DEVIATION_SOFT_STOP   | Stop on position deviation, soft stop. 4   |
 * STOP_ON_VEL_DEVIATION             | Stop on velocity deviation. 5   |
 * STOP_ON_VEL_DEVIATION_SOFT_STOP   | Stop on velocity deviation, soft stop. 6   |
 * STOP_ON_POS_VEL_DEVIATION         | Stop on position or velocity deviation. 7   |
 * STOP_ON_POS_VEL_DEVIATION_SOFT_STOP | Stop on position or velocity deviation, soft stop.
 */
#define EVENT_STOP_SETTINGS_LIST(X)                                                                \
  ...
  X(STOP_ON_POS_VEL_DEVIATION_SOFT_STOP, 7,                                                        \
    /*!< Stop on position or velocity deviation, soft stop. */)
 ...
 *
 * The TMC9660 Parameter Mode includes biquad filters to enhance the performance of its velocity and
 * torque control loops. The biquad filter is a second-order digital filter, operating on current
 * and past input/output samples using configurable coefficients.
 *
 ...
 *
 * The velocity biquad filter (enabled by default) filters the actual velocity used as input for the
 * velocity controller. The torque biquad filter can be enabled to filter the target torque value.
 *
 * NUMBER | NAME                             | DESCRIPTION
 * ------ | -------------------------------- | -----------------------------------------------
 * 318    | TARGET_TORQUE_BIQUAD_FILTER_ENABLE      | Enable target torque biquad filter. 0:
 * DISABLED, 1: ENABLED. Default: 0. RWE 319    | TARGET_TORQUE_BIQUAD_FILTER_ACOEFF_1    | Target
 * torque biquad filter aCoeff_1 [-2147483648, 2147483647]. Default: 0. RWE 320    |
 * TARGET_TORQUE_BIQUAD_FILTER_ACOEFF_2    | Target torque biquad filter aCoeff_2 [-2147483648,
 * 2147483647]. Default: 0. RWE 321    | TARGET_TORQUE_BIQUAD_FILTER_BCOEFF_0    | Target torque
 * biquad filter bCoeff_0 [-2147483648, 2147483647]. Default: 1048576. RWE 322    |
 * TARGET_TORQUE_BIQUAD_FILTER_BCOEFF_1    | Target torque biquad filter bCoeff_1 [-2147483648,
 * 2147483647]. Default: 0. RWE 323    | TARGET_TORQUE_BIQUAD_FILTER_BCOEFF_2    | Target torque
 * biquad filter bCoeff_2 [-2147483648, 2147483647]. Default: 0. RWE 324    |
 * ACTUAL_VELOCITY_BIQUAD_FILTER_ENABLE    | Enable actual velocity biquad filter. 0: DISABLED, 1:
 * ENABLED. Default: 1. RWE 325    | ACTUAL_VELOCITY_BIQUAD_FILTER_ACOEFF_1  | Actual velocity
 * biquad filter aCoeff_1 [-2147483648, 2147483647]. Default: 1849195. RWE 326    |
 * ACTUAL_VELOCITY_BIQUAD_FILTER_ACOEFF_2  | Actual velocity biquad filter aCoeff_2 [-2147483648,
 * 2147483647]. Default: 15961938. RWE 327    | ACTUAL_VELOCITY_BIQUAD_FILTER_BCOEFF_0  | Actual
 * velocity biquad filter bCoeff_0 [-2147483648, 2147483647]. Default: 3665. RWE 328    |
 * ACTUAL_VELOCITY_BIQUAD_FILTER_BCOEFF_1  | Actual velocity biquad filter bCoeff_1 [-2147483648,
 * 2147483647]. Default: 7329. RWE 329    | ACTUAL_VELOCITY_BIQUAD_FILTER_BCOEFF_2  | Actual
 * velocity biquad filter bCoeff_2 [-2147483648, 2147483647]. Default: 3665. RWE
 */
#define BIQUAD_FILTER_LIST(X)                                                                      \
  X(TARGET_TORQUE_BIQUAD_FILTER_ENABLE, 318,                                                       \
    /*!< Enable target torque biquad filter. 0: DISABLED, 1: ENABLED. Default: 0. RWE */)          \
  X(TARGET_TORQUE_BIQUAD_FILTER_ACOEFF_1, 319,                                                     \
    /*!< Target torque biquad filter aCoeff_1 [-2147483648, 2147483647]. Default: 0. RWE */)       \
  X(TARGET_TORQUE_BIQUAD_FILTER_ACOEFF_2, 320,                                                     \
    /*!< Target torque biquad filter aCoeff_2 [-2147483648, 2147483647]. Default: 0. RWE */)       \
  X(TARGET_TORQUE_BIQUAD_FILTER_BCOEFF_0, 321,                                                     \
    /*!< Target torque biquad filter bCoeff_0 [-2147483648, 2147483647]. Default: 1048576. RWE */) \
  X(TARGET_TORQUE_BIQUAD_FILTER_BCOEFF_1, 322,                                                     \
    /*!< Target torque biquad filter bCoeff_1 [-2147483648, 2147483647]. Default: 0. RWE */)       \
  X(TARGET_TORQUE_BIQUAD_FILTER_BCOEFF_2, 323,                                                     \
    /*!< Target torque biquad filter bCoeff_2 [-2147483648, 2147483647]. Default: 0. RWE */)       \
  X(ACTUAL_VELOCITY_BIQUAD_FILTER_ENABLE, 324,                                                     \
    /*!< Enable actual velocity biquad filter. 0: DISABLED, 1: ENABLED. Default: 1. RWE */)        \
  ...
  X(ACTUAL_VELOCITY_BIQUAD_FILTER_BCOEFF_0, 327,                                                   \
    /*!< Actual velocity biquad filter bCoeff_0 [-2147483648, 2147483647]. Default: 3665. RWE */)  \
  X(ACTUAL_VELOCITY_BIQUAD_FILTER_BCOEFF_1, 328,                                                   \
    /*!< Actual velocity biquad filter bCoeff_1 [-2147483648, 2147483647]. Default: 7329. RWE */)  \
  X(ACTUAL_VELOCITY_BIQUAD_FILTER_BCOEFF_2, 329,                                                   \
    /*!< Actual velocity biquad filter bCoeff_2 [-2147483648, 2147483647]. Default: 3665. RWE */)
 ...
 * The system can be configured to react with open-circuit, electrical braking, and/or mechanical
 * braking. For gate driver faults, a retry mechanism is available. The number of retries and retry
 * behavior are configurable. If all retries fail, the standard drive fault behavior is applied.
 *
 * Table — Fault Handling Parameters:
 *  NUMBER | NAME                        | DESCRIPTION
 *  ------ | --------------------------- |
 * ----------------------------------------------------------------- 286   | GDRV_RETRY_BEHAVIOUR |
 * State after a gate driver fault. See GdrvRetryBehaviour. Default: 0 (OPEN_CIRCUIT). RWE 287   |
 * DRIVE_FAULT_BEHAVIOUR       | State after all retries fail. See DriveFaultBehaviour. Default: 0
 * (OPEN_CIRCUIT). RWE 288   | FAULT_HANDLER_NUMBER_OF_RETRIES | Max number of retries per detected
 * fault [0...255]. Default: 5. RWE
 */
#define FAULT_HANDLING_LIST(X)                                                                     \
  ...
  X(DRIVE_FAULT_BEHAVIOUR, 287,                                                                    \
    /*!< State after all retries fail. See DriveFaultBehaviour. Default: 0 (OPEN_CIRCUIT). RWE */) \
  X(FAULT_HANDLER_NUMBER_OF_RETRIES, 288,                                                          \
    /*!< Max number of retries per detected fault [0...255]. Default: 5. RWE */)
 ...
 *     1   | ELECTRICAL_BRAKING | Switch off and, if possible, enable LS or HS gates for electrical
 * braking.
 */
#define GDRV_RETRY_BEHAVIOUR_LIST(X)                                                               \
  ...
  X(ELECTRICAL_BRAKING, 1,                                                                         \
    /*!< Switch off and, if possible, enable LS or HS gates for electrical braking. */)
 ...
 *  NUMBER | NAME                                | DESCRIPTION
 *  ------ | ----------------------------------- |
 * ----------------------------------------------------------------- 0   | OPEN_CIRCUIT | Switch off
 * and discharge LS/HS gates; motor spins freely. 1   | ELECTRICAL_BRAKING                 | Switch
 * off and, if possible, enable LS/HS gates for electrical braking. 2   |
 * MECHANICAL_BRAKING_AND_OPEN_CIRCUIT| Switch off, discharge LS/HS gates, and engage mechanical
 * brake if configured. 3   | MECHANICAL_AND_ELECTRICAL_BRAKING  | Switch off, enable LS/HS gates if
 * possible, and engage mechanical brake if configured.
 */
#define DRIVE_FAULT_BEHAVIOUR_LIST(X)                                                              \
  X(OPEN_CIRCUIT, 0, /*!< Switch off and discharge LS/HS gates; motor spins freely. */)            \
  X(ELECTRICAL_BRAKING, 1,                                                                         \
    /*!< Switch off and, if possible, enable LS/HS gates for electrical braking. */)               \
  X(MECHANICAL_BRAKING_AND_OPEN_CIRCUIT, 2,                                                        \
    /*!< Switch off, discharge LS/HS gates, and engage mechanical brake if configured. */)         \
 ...
 *
 * The IIT monitor protects against overtemperature in sustained load conditions by monitoring the
 * total current flowing into the motor (torque and flux). Two independent IIT monitoring windows
 * are supported, each with its own time constant and limit. If the squared current sum exceeds the
 * limit, an emergency stop is triggered. The behavior is defined by DRIVE_FAULT_BEHAVIOUR. Status
 * flags indicate active protection and limit exceeded.
 *
 ...
 * - If the sum exceeds the limit, the corresponding IIT_EXCEEDED flag is set and the motor is
 * stopped.
 ...
 *  ------ | --------------------------- |
 * ----------------------------------------------------------------- 224   |
 * THERMAL_WINDING_TIME_CONSTANT_1 | Time constant for IIT window 1 [ms]. Default: 3000. 225   |
 * IIT_LIMIT_1                 | IIT limit for window 1 [A^2 x ms]. Default: 4294967295. 226   |
 * IIT_SUM_1                   | Actual IIT sum for window 1 [A^2 x ms]. Default: 0. 227   |
 * THERMAL_WINDING_TIME_CONSTANT_2 | Time constant for IIT window 2 [ms]. Default: 6000. 228   |
 * IIT_LIMIT_2                 | IIT limit for window 2 [A^2 x ms]. Default: 4294967295. 229   |
 * IIT_SUM_2                   | Actual IIT sum for window 2 [A^2 x ms]. Default: 0. 230   |
 * RESET_IIT_SUMS              | Write to reset both IIT sums. Default: 0. 231   |
 * ACTUAL_TOTAL_MOTOR_CURRENT  | Total current through motor windings [mA]. Default: 0.
 */
#define IIT_MONITOR_LIST(X)                                                                        \
  X(THERMAL_WINDING_TIME_CONSTANT_1, 224,                                                          \
    /*!< Time constant for IIT window 1 [ms]. Default: 3000. */)                                   \
  ...
  X(THERMAL_WINDING_TIME_CONSTANT_2, 227,                                                          \
    /*!< Time constant for IIT window 2 [ms]. Default: 6000. */)                                   \
 ...
 *
 * The TMC9660 integrates protections using both an external analog temperature sensor (AIN3) and an
 * internal chip sensor.
 * - EXTERNAL_TEMPERATURE can be converted to voltage: Voltage[V] = par(EXTERNAL_TEMPERATURE) × 2.5V
 * / (2^16 - 1)
 * - CHIP_TEMPERATURE can be converted to °C: Temperature[°C] = par(CHIP_TEMPERATURE) × 0.01615 -
 * 268.15
 * - Warning and shutdown thresholds can be set for both sensors. Exceeding a warning threshold sets
 * a warning flag. Exceeding a shutdown threshold initiates a motor shutdown, as defined by
 * DRIVE_FAULT_BEHAVIOUR.
 * - To restart after shutdown, clear the corresponding error flag.
 *
 * Table — Temperature Protection Parameters:
 *  NUMBER | NAME                                  | DESCRIPTION
 *  ------ | ------------------------------------- |
 * ----------------------------------------------------------------- 293   | EXTERNAL_TEMPERATURE |
 * External temperature sensor value [0...65535]. 294   | EXTERNAL_TEMPERATURE_SHUTDOWN_THRESHOLD |
 * Shutdown threshold for external temperature [0...65535]. Default: 65535. 295   |
 * EXTERNAL_TEMPERATURE_WARNING_THRESHOLD  | Warning threshold for external temperature [0...65535].
 * Default: 65535. 296   | CHIP_TEMPERATURE                      | Internal chip temperature value
 * [0...65535]. 297   | CHIP_TEMPERATURE_SHUTDOWN_THRESHOLD   | Shutdown threshold for chip
 * temperature [0...65535]. Default: 65535. 298   | CHIP_TEMPERATURE_WARNING_THRESHOLD    | Warning
 * threshold for chip temperature [0...65535]. Default: 65535.
 */
#define TEMPERATURE_PROTECTION_LIST(X)                                                             \
  ...
  X(EXTERNAL_TEMPERATURE_SHUTDOWN_THRESHOLD, 294,                                                  \
    /*!< Shutdown threshold for external temperature [0...65535]. Default: 65535. */)              \
  X(EXTERNAL_TEMPERATURE_WARNING_THRESHOLD, 295,                                                   \
    /*!< Warning threshold for external temperature [0...65535]. Default: 65535. */)               \
  X(CHIP_TEMPERATURE, 296, /*!< Internal chip temperature value [0...65535]. */)                   \
  X(CHIP_TEMPERATURE_SHUTDOWN_THRESHOLD, 297,                                                      \
    /*!< Shutdown threshold for chip temperature [0...65535]. Default: 65535. */)                  \
  X(CHIP_TEMPERATURE_WARNING_THRESHOLD, 298,                                                       \
    /*!< Warning threshold for chip temperature [0...65535]. Default: 65535. */)
...
inline const char *to_string(TemperatureProtection e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case TemperatureProtection::NAME:                                                                \
    return #NAME;
    TEMPERATURE_PROTECTION_LIST(X)
#undef X
  default:
 ...
 *
 * The heartbeat monitor checks for regular communication on UART and/or SPI. If no datagram is
 * received within the configured timeout, the system initiates a motor shutdown (behavior defined
 * by DRIVE_FAULT_BEHAVIOUR). The status flag HEARTBEAT_STOPPED is raised.
 *
 * Table — Heartbeat Monitoring Parameters:
 *  NUMBER | NAME                      | DESCRIPTION
 *  ------ | ------------------------- | -----------------------------------------------
 *     3   | HEARTBEAT_MONITORING_CONFIG | Heartbeat monitoring config. 0: DISABLED, 1: UART, 2:
 * SPI, 3: UART+SPI. 4   | HEARTBEAT_MONITORING_TIMEOUT | Heartbeat timeout in ms [1...4294967295].
 * Default: 100.
 */
#define HEARTBEAT_MONITORING_LIST(X)                                                               \
  X(HEARTBEAT_MONITORING_CONFIG, 3,                                                                \
    /*!< Heartbeat monitoring config. 0: DISABLED, 1: UART, 2: SPI, 3: UART+SPI. */)               \
  X(HEARTBEAT_MONITORING_TIMEOUT, 4,                                                               \
    /*!< Heartbeat timeout in ms [1...4294967295]. Default: 100. */)
...
inline const char *to_string(HeartbeatMonitoringConfig e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case HeartbeatMonitoringConfig::NAME:                                                            \
    return #NAME;
    HEARTBEAT_MONITORING_CONFIG_LIST(X)
#undef X
  default:
 ...
 *
 * The brake chopper dissipates excess energy via an external brake resistor and MOSFET when supply
 ...
 *  NUMBER | NAME                        | DESCRIPTION
 *  ------ | --------------------------- |
 * ----------------------------------------------------------------- 212   | BRAKE_CHOPPER_ENABLE |
 * Enable brake chopper. 0: DISABLED, 1: ENABLED. Default: 0. RWE 213   |
 * BRAKE_CHOPPER_VOLTAGE_LIMIT | Voltage limit [0.1V] to activate brake chopper. 50...1000. Default:
 * 260. RWE 214   | BRAKE_CHOPPER_HYSTERESIS    | Hysteresis [0.1V] for deactivation. 0...50.
 * Default: 5. RWE
 */
#define BRAKE_CHOPPER_LIST(X)                                                                      \
  X(BRAKE_CHOPPER_ENABLE, 212,                                                                     \
    /*!< Enable brake chopper. 0: DISABLED, 1: ENABLED. Default: 0. RWE */)                        \
  X(BRAKE_CHOPPER_VOLTAGE_LIMIT, 213,                                                              \
    /*!< Voltage limit [0.1V] to activate brake chopper. 50...1000. Default: 260. RWE */)          \
  X(BRAKE_CHOPPER_HYSTERESIS, 214,                                                                 \
    /*!< Hysteresis [0.1V] for deactivation. 0...50. Default: 5. RWE */)
 ...
 *
 * The mechanical brake is controlled by a PWM output. Release is triggered by setting
 * RELEASE_BRAKE.
 ...
 *  NUMBER | NAME                      | DESCRIPTION
 *  ------ | ------------------------- |
 * ----------------------------------------------------------------- 216   | RELEASE_BRAKE | Release
 * brake (apply PWM). 0: DEACTIVATED, 1: ACTIVATED. Default: 0. 217   | BRAKE_RELEASING_DUTY_CYCLE|
 * Duty cycle [%] for releasing phase. 0...99. Default: 75. 218   | BRAKE_HOLDING_DUTY_CYCLE  | Duty
 * cycle [%] for holding phase. 0...99. Default: 11. 219   | BRAKE_RELEASING_DURATION  | Duration
 * [ms] for releasing phase. 0...65535. Default: 80. 221   | INVERT_BRAKE_OUTPUT       | Invert
 * brake output. 0: NORMAL, 1: INVERTED. Default: 0.
 */
#define MECHANICAL_BRAKE_LIST(X)                                                                   \
  X(RELEASE_BRAKE, 216,                                                                            \
    /*!< Release brake (apply PWM). 0: DEACTIVATED, 1: ACTIVATED. Default: 0. */)                  \
  X(BRAKE_RELEASING_DUTY_CYCLE, 217,                                                               \
    /*!< Duty cycle [%] for releasing phase. 0...99. Default: 75. */)                              \
  X(BRAKE_HOLDING_DUTY_CYCLE, 218, /*!< Duty cycle [%] for holding phase. 0...99. Default: 11. */) \
  X(BRAKE_RELEASING_DURATION, 219,                                                                 \
    /*!< Duration [ms] for releasing phase. 0...65535. Default: 80. */)                            \
 ...
 *
 * The TMC9660 supports eight different reference search patterns, configurable via
 * REFERENCE_SWITCH_SEARCH_MODE. Two speeds can be set: REFERENCE_SWITCH_SEARCH_SPEED (fast search)
 * and REFERENCE_SWITCH_SPEED (slow, for accuracy). Switch positions can be read out after search.
 * The TMCL command RFS (13) is used to start/stop/query the search.
 *
 * Table — Reference Search (Automatic Homing) Parameters:
 *  NUMBER | NAME                          | DESCRIPTION
 *  ------ | ----------------------------- |
 * ----------------------------------------------------------------- 165   |
 * REFERENCE_SWITCH_SEARCH_MODE  | Reference search mode. See ReferenceSearchMode. Default: 0. 166
 * | REFERENCE_SWITCH_SEARCH_SPEED | Speed for reference search [-134217728...134217727]. Default:
 * 0. 167   | REFERENCE_SWITCH_SPEED        | Lower speed for accurate switch positioning
 * [-134217728...134217727]. Default: 0. 168   | RIGHT_LIMIT_SWITCH_POSITION   | Position of right
 * limit switch [-2147483648...2147483647]. Default: 0. 169   | HOME_SWITCH_POSITION          |
 * Position of home switch [-2147483648...2147483647]. Default: 0. 170   | LAST_REFERENCE_POSITION
 * | Last reference position [-2147483648...2147483647]. Default: 0.
 */
#define REFERENCE_SEARCH_LIST(X)                                                                   \
  X(REFERENCE_SWITCH_SEARCH_MODE, 165,                                                             \
    /*!< Reference search mode. See ReferenceSearchMode. Default: 0. */)                           \
  X(REFERENCE_SWITCH_SEARCH_SPEED, 166,                                                            \
    /*!< Speed for reference search [-134217728...134217727]. Default: 0. */)                      \
  X(REFERENCE_SWITCH_SPEED, 167,                                                                   \
    /*!< Lower speed for accurate switch positioning [-134217728...134217727]. Default: 0. */)     \
  X(RIGHT_LIMIT_SWITCH_POSITION, 168,                                                              \
    /*!< Position of right limit switch [-2147483648...2147483647]. Default: 0. */)                \
  X(HOME_SWITCH_POSITION, 169,                                                                     \
    /*!< Position of home switch [-2147483648...2147483647]. Default: 0. */)                       \
 ...
 *  NUMBER | NAME                                   | DESCRIPTION
 *  ------ | ------------------------------------- |
 * ----------------------------------------------------------------- 1   | LEFT_SWITCH | Search for
 * left limit switch. 2   | RIGHT_SWITCH_LEFT_SWITCH              | Search right limit, then left
 * limit switch. 3   | RIGHT_SWITCH_LEFT_SWITCH_BOTH_SIDES   | Right limit, then approach left limit
 * from both sides. 4   | LEFT_SWITCH_BOTH_SIDES                | Approach left limit from both
 * sides. 5   | HOME_SWITCH_NEG_DIR_LEFT_END_SWITCH   | Search home switch in negative direction,
 * turn if left end detected. 6   | HOME_SWITCH_POS_DIR_RIGHT_END_SWITCH  | Search home switch in
 * positive direction, turn if right end detected. 7   | HOME_SWITCH_NEG_DIR_IGNORE_END_SWITCH |
 * Search home switch in negative direction, ignore end switch. 8   |
 * HOME_SWITCH_POS_DIR_IGNORE_END_SWITCH | Search home switch in positive direction, ignore end
 * switch.
 */
#define REFERENCE_SEARCH_MODE_LIST(X)                                                              \
  ...
  X(RIGHT_SWITCH_LEFT_SWITCH_BOTH_SIDES, 3,                                                        \
    /*!< Right limit, then approach left limit from both sides. */)                                \
  X(LEFT_SWITCH_BOTH_SIDES, 4, /*!< Approach left limit from both sides. */)                       \
  X(HOME_SWITCH_NEG_DIR_LEFT_END_SWITCH, 5,                                                        \
    /*!< Search home switch in negative direction, turn if left end detected. */)                  \
  X(HOME_SWITCH_POS_DIR_RIGHT_END_SWITCH, 6,                                                       \
    /*!< Search home switch in positive direction, turn if right end detected. */)                 \
  X(HOME_SWITCH_NEG_DIR_IGNORE_END_SWITCH, 7,                                                      \
    /*!< Search home switch in negative direction, ignore end switch. */)                          \
  X(HOME_SWITCH_POS_DIR_IGNORE_END_SWITCH, 8,                                                      \
    /*!< Search home switch in positive direction, ignore end switch. */)
...
inline const char *to_string(ReferenceSwitchSearchMode e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case ReferenceSwitchSearchMode::NAME:                                                            \
    return #NAME;
    REFERENCE_SEARCH_MODE_LIST(X)
#undef X
  default:
...
inline const char *to_string(ReferenceSearchCommand e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case ReferenceSearchCommand::NAME:                                                               \
    return #NAME;
    REFERENCE_SEARCH_COMMAND_LIST(X)
#undef X
  default:
 ...
 *  NUMBER | NAME                                   | DESCRIPTION
 *  ------ | ------------------------------------- |
 * ----------------------------------------------------------------- 0   | IDLE | No description
 * provided. 1   | START_REFERENCE_DRIVE                 | No description provided. 2   |
 * START_DRIVE_TO_RIGHT_LIMIT_FAST       | No description provided. 3   |
 * WAIT_UNTIL_RIGHT_SWITCH_REACHED       | No description provided. 4   |
 * START_DRIVE_TO_LEFT_LIMIT_FAST        | No description provided. 5   |
 * WAIT_UNTIL_LEFT_SWITCH_REACHED        | No description provided. 6   |
 * DRIVE_OUT_OF_LEFT_SWITCH_SLOWLY       | No description provided. 7   |
 * WAIT_UNTIL_LEFT_SWITCH_EXITED_DRIVE_IN_AGAIN | No description provided. 8   |
 * WAIT_UNTIL_LEFT_SWITCH_REACHED_AGAIN_DRIVE_TO_POSITION | No description provided. 9   |
 * WAIT_UNTIL_POSITION_REACHED_SET_ZERO  | No description provided. 10   |
 * WAIT_UNTIL_SWITCH_PUSHED_AGAIN        | No description provided. 11   |
 * WAIT_UNTIL_OTHER_SIDE_SWITCH_REACHED  | No description provided. 12   | RESERVED | No description
 * provided. 13   | WAIT_UNTIL_CENTER_SWITCH_REACHED      | No description provided. 14   |
 * REFERENCE_DRIVE_FINISHED_RESTORE_SETTINGS | No description provided. 15   | STOP_REFERENCE_DRIVE
...
inline const char *to_string(ReferenceSearchStatus e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case ReferenceSearchStatus::NAME:                                                                \
    return #NAME;
    REFERENCE_SEARCH_STATUS_LIST(X)
#undef X
  default:
 ...
 *
 * The STEP/DIR interface allows position control via step and direction signals. Supports
 * micro-stepping, extrapolation, and velocity feedforward. Micro-stepping is set by
 * STEP_DIR_STEP_DIVIDER_SHIFT (1/1 to 1/1024). Extrapolation smooths movement between steps and can
 * be limited by velocity. Timeout and correction are configurable.
 *
 * NUMBER | NAME                                | DESCRIPTION
 * ------ | ----------------------------------- | ---------------------------------------------
 *    68  | VELOCITY_FEEDFORWARD_ENABLE         | Enable velocity feedforward. 0: DISABLED, 1:
 * ENABLED. Default: 0. RWE 205  | STEP_DIR_STEP_DIVIDER_SHIFT         | Micro-step divider shift
 * (see StepDirStepDividerShift). Default: 0 (full step). RWE 206  | STEP_DIR_ENABLE | Enable
 * STEP/DIR input. 0: DISABLED, 1: ENABLED. Default: 0. RW 207  | STEP_DIR_EXTRAPOLATION_ENABLE |
 * Enable extrapolation. 0: DISABLED, 1: ENABLED. Default: 0. RW 208  |
 * STEP_DIR_STEP_SIGNAL_TIMEOUT_LIMIT  | Step signal timeout limit [ms]. 1...2000. Default: 1000. RW
 *   209  | STEP_DIR_MAXIMUM_EXTRAPOLATION_VELOCITY | Max velocity for extrapolation [eRPM].
 * 0...2147483647. Default: 2147483647. RW
 */
#define STEP_DIR_LIST(X)                                                                           \
  /* VELOCITY_FEEDFORWARD_ENABLE defined in VELOCITY_CONTROL_LIST */                               \
  X(STEP_DIR_STEP_DIVIDER_SHIFT, 205,                                                              \
    /*!< Micro-step divider shift (see StepDirStepDividerShift). Default: 0 (full step). RWE */)   \
  X(STEP_DIR_ENABLE, 206, /*!< Enable STEP/DIR input. 0: DISABLED, 1: ENABLED. Default: 0. RW */)  \
  X(STEP_DIR_EXTRAPOLATION_ENABLE, 207,                                                            \
    /*!< Enable extrapolation. 0: DISABLED, 1: ENABLED. Default: 0. RW */)                         \
  X(STEP_DIR_STEP_SIGNAL_TIMEOUT_LIMIT, 208,                                                       \
    /*!< Step signal timeout limit [ms]. 1...2000. Default: 1000. RW */)                           \
  X(STEP_DIR_MAXIMUM_EXTRAPOLATION_VELOCITY, 209,                                                  \
    /*!< Max velocity for extrapolation [eRPM]. 0...2147483647. Default: 2147483647. RW */)
...
inline const char *to_string(StepDirStepDividerShift e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case StepDirStepDividerShift::NAME:                                                              \
    return #NAME;
    STEP_DIR_STEP_DIVIDER_SHIFT_LIST(X)
#undef X
  default:
 ...
 *
 * The TMC9660 can be sent to a low-power hibernation state using WAKE_PIN_CONTROL_ENABLE or
 ...
 *   If the WAKE pin is configured, pulling it low powers down the device; pulling it high wakes it
 * up.
 *
 * Table — Hibernation and Wakeup Parameters:
 *  NUMBER | NAME                      | DESCRIPTION
 *  ------ | ------------------------- |
 * ----------------------------------------------------------------- 10   | WAKE_PIN_CONTROL_ENABLE
 * | Enable WAKE pin control. 0: DISABLED, 1: ENABLED. Default: 0. RWE 11   |
 * GO_TO_TIMEOUT_POWER_DOWN_STATE | Enter power-down for a predefined time. See PowerDownTimeout.
 * Default: 0. W
 */
#define HIBERNATION_WAKEUP_LIST(X)                                                                 \
  X(WAKE_PIN_CONTROL_ENABLE, 10,                                                                   \
    /*!< Enable WAKE pin control. 0: DISABLED, 1: ENABLED. Default: 0. RWE */)                     \
  X(GO_TO_TIMEOUT_POWER_DOWN_STATE, 11,                                                            \
    /*!< Enter power-down for a predefined time. See PowerDownTimeout. Default: 0. W */)
 ...
 *   291  | SUPPLY_OVERVOLTAGE_WARNING_THRESHOLD | Supply overvoltage warning threshold [0…1000].
 * RWE 292  | SUPPLY_UNDERVOLTAGE_WARNING_THRESHOLD | Supply undervoltage warning threshold
 * [0…1000]. RWE
 */
#define SYSTEM_STATUS_SUPPLY_LIST(X)                                                               \
  ...
  X(SUPPLY_OVERVOLTAGE_WARNING_THRESHOLD, 291,                                                     \
    /*!< Supply overvoltage warning threshold [0…1000]. RWE */)                                    \
  X(SUPPLY_UNDERVOLTAGE_WARNING_THRESHOLD, 292,                                                    \
    /*!< Supply undervoltage warning threshold [0…1000]. RWE */)
 ...
 *
 * These parameters provide access to interim results and measurements from the Field-Oriented
 * Control (FOC) algorithm, as well as raw input states. They are useful for debugging and
 * diagnostics.
 *
 * NUMBER | NAME                                | DESCRIPTION
 * ------ | ----------------------------------- | -----------
 *   304  | MCC_INPUTS_RAW                     | Raw inputs for ABN, hall, reference switches,
 * driver enabled, hall filtered and ABN2 or Step/Dir [0...32767]. Read-only. 305  | FOC_VOLTAGE_UX
 * | Interim result of the FOC for phase U (X in case of stepper motor) [-32768...32767]. Read-only.
 *   306  | FOC_VOLTAGE_WY                     | Interim result of the FOC for phase W (Y in case of
 * stepper motor) [-32768...32767]. Read-only. 307  | FOC_VOLTAGE_V                      | Interim
 * result of the FOC for phase V (BLDC motor only) [-32768...32767]. Read-only. 308  |
 * FIELDWEAKENING_I                   | I parameter for field weakening controller [0...32767].
 * Default: 0. RWE 310  | FIELDWEAKENING_VOLTAGE_THRESHOLD   | Maximum motor voltage allowed for
 * field weakening [0...32767]. Default: 32767. RWE 311  | FOC_CURRENT_UX                     |
 * Interim measurement of the FOC for phase UX [-32768...32767]. Read-only. 312  | FOC_CURRENT_V |
 * Interim measurement of the FOC for phase V [-32768...32767]. Read-only. 313  | FOC_CURRENT_WY |
 * Interim measurement of the FOC for phase WY [-32768...32767]. Read-only. 314  | FOC_VOLTAGE_UQ |
 * Interim measurement of the FOC for Uq [-32768...32767]. Read-only. 315  | FOC_CURRENT_IQ |
 * Interim measurement of the FOC for Iq [-32768...32767]. Read-only.
 */
#define INTERNAL_MEASUREMENT_LIST(X)                                                               \
  ...
  X(FOC_VOLTAGE_V, 307,                                                                            \
    /*!< Interim result of the FOC for phase V (BLDC motor only) [-32768...32767]. Read-only. */)  \
  /* FIELDWEAKENING_I and FIELDWEAKENING_VOLTAGE_THRESHOLD defined in TORQUE_FLUX_CONTROL_LIST */  \
  X(FOC_CURRENT_UX, 311,                                                                           \
    /*!< Interim measurement of the FOC for phase UX [-32768...32767]. Read-only. */)              \
  X(FOC_CURRENT_V, 312,                                                                            \
    /*!< Interim measurement of the FOC for phase V [-32768...32767]. Read-only. */)               \
  X(FOC_CURRENT_WY, 313,                                                                           \
    /*!< Interim measurement of the FOC for phase WY [-32768...32767]. Read-only. */)              \
  X(FOC_VOLTAGE_UQ, 314,                                                                           \
    /*!< Interim measurement of the FOC for Uq [-32768...32767]. Read-only. */)                    \
 ...
 * NUMBER | NAME                                | DESCRIPTION
 * ------ | ----------------------------------- | -----------
 *   330  | TORQUE_FLUX_COMBINED_TARGET_VALUES | Raw (unscaled) torque and flux target values
 * combined into one 32-bit value. Used for simplified compact measurement during tuning.
 * [0...4294967295]. Read-only. 331  | TORQUE_FLUX_COMBINED_ACTUAL_VALUES | Raw (unscaled) torque
 * and flux actual values combined into one 32-bit value. Used for simplified compact measurement
 * during tuning. [0...4294967295]. Read-only. 332  | VOLTAGE_D_Q_COMBINED_ACTUAL_VALUES | Raw
 * (unscaled) voltage actual values combined into one 32-bit value. Used for simplified compact
 * measurement during tuning. [0...4294967295]. Read-only. 333  | INTEGRATED_ACTUAL_TORQUE_VALUE |
 * Periodically summed up actual torque value. Used for simplified measurement with low measurement
 * frequency during tuning operations. [0...4294967295]. Read-only. 334  |
 * INTEGRATED_ACTUAL_VELOCITY_VALUE   | Periodically summed up actual velocity value. Used for
 * simplified measurement with low measurement frequency during tuning operations. [0...4294967295].
 * Read-only.
 */
...
inline const char *to_string(CombinedDiagnosticValues e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case CombinedDiagnosticValues::NAME:                                                             \
    return #NAME;
    COMBINED_DIAGNOSTIC_VALUES_LIST(X)
#undef X
  default:
 ...
 * NUMBER | NAME                                | DESCRIPTION
 * ------ | ----------------------------------- | -----------
 *   289  | GENERAL_STATUS_FLAGS               | General status flags. See GeneralStatusFlags enum.
 * Read-only. 293  | EXTERNAL_TEMPERATURE               | External temperature sensor reading
 * [0-65535]. Read-only. 294  | EXTERNAL_TEMPERATURE_SHUTDOWN_THRESHOLD | Shutdown threshold for
 * external temperature [0-65535]. Default: 65535. 295  | EXTERNAL_TEMPERATURE_WARNING_THRESHOLD  |
 * Warning threshold for external temperature [0-65535]. Default: 65535. 296  | CHIP_TEMPERATURE |
 * Chip temperature reading [0-65535]. Read-only. 297  | CHIP_TEMPERATURE_SHUTDOWN_THRESHOLD |
 * Shutdown threshold for chip temperature [0-65535]. Default: 65535. 298  |
 * CHIP_TEMPERATURE_WARNING_THRESHOLD  | Warning threshold for chip temperature [0-65535]. Default:
 * 65535. 299  | GENERAL_ERROR_FLAGS                | General error flags. See GeneralErrorFlags
 * enum. Read-only. 300  | GDRV_ERROR_FLAGS                   | Gate driver error flags. See
 * GateDriverErrorFlags enum. Read-only. 301  | ADC_STATUS_FLAGS                   | ADC status
 * flags. See AdcStatusFlags enum. Write-to-clear.
 */
#define ERRORS_AND_FLAGS_LIST(X)                                                                   \
  X(GENERAL_STATUS_FLAGS, 289,                                                                     \
    /*!< General status flags. See GeneralStatusFlags enum. Read-only. */)                         \
  ...
  X(GDRV_ERROR_FLAGS, 300,                                                                         \
    /*!< Gate driver error flags. See GateDriverErrorFlags enum. Read-only. */)                    \
 ...
 *
 * This 32-bit status register contains flags that provide information about the current system
 * state, regulation modes, configuration status, hardware events, and available peripherals.
 *
 ...
 * FLAG(9)  | POSITION_REACHED              | Actual velocity and target velocity are below
 * POSITION_REACHED_THRESHOLD. Read-only. FLAG(10) | VELOCITY_REACHED              | Actual velocity
 * and target velocity are below VELOCITY_REACHED_THRESHOLD. Read-only. FLAG(11) |
 * ADC_OFFSET_CALIBRATED         | The ADC offset was calibrated automatically (clear to
 * recalibrate). Read-write-clear. FLAG(12) | RAMPER_LATCHED                | The ramper latched a
 * position. Read-write-clear. FLAG(13) | RAMPER_EVENT_STOP_SWITCH      | Ramper had a switch stop
 * event. Read-only. FLAG(14) | RAMPER_EVENT_STOP_DEVIATION   | Ramper had a deviation stop event.
 * Read-write-clear. FLAG(15) | RAMPER_VELOCITY_REACHED       | The ramper reached its velocity
 * target. Read-only. FLAG(16) | RAMPER_POSITION_REACHED       | The ramper reached its position
 * target. Read-only. FLAG(17) | RAMPER_SECOND_MOVE            | The ramper needed a second move to
 * reach target. Read-write-clear. FLAG(18) | IIT_1_ACTIVE                  | IIT 1 active.
 * Read-only. FLAG(19) | IIT_2_ACTIVE                  | IIT 2 active. Read-only. FLAG(20) |
 * REFSEARCH_FINISHED            | Reference search finished. Read-only. FLAG(21) |
 * Y2_USED_FOR_BRAKING           | Fourth phase used for braking. Read-only. FLAG(23) |
 * STEPDIR_INPUT_AVAILABLE       | Signals that StepDir is available. Read-only. FLAG(24) |
 * RIGHT_REF_SWITCH_AVAILABLE    | Signals that REF_R is available. Read-only. FLAG(25) |
 * HOME_REF_SWITCH_AVAILABLE     | Signals that REF_H is available. Read-only. FLAG(26) |
 * LEFT_REF_SWITCH_AVAILABLE     | Signals that REF_L is available. Read-only. FLAG(27) |
 * ABN2_FEEDBACK_AVAILABLE       | Signals that ABN2 feedback is available. Read-only. FLAG(28) |
 * HALL_FEEDBACK_AVAILABLE       | Signals that hall feedback is available. Read-only. FLAG(29) |
 * ABN1_FEEDBACK_AVAILABLE       | Signals that ABN1 feedback is available. Read-only. FLAG(30) |
 * SPI_FLASH_AVAILABLE           | Signals that an external SPI flash is available. Read-only.
 * FLAG(31) | I2C_EEPROM_AVAILABLE          | Signals that an external I2C EEPROM is available.
 * Read-only.
 */
#define GENERAL_STATUS_FLAGS_LIST(X)                                                               \
  ...
  X(POSITION_REACHED, FLAG(9),                                                                     \
    /*!< Actual velocity and target velocity are below POSITION_REACHED_THRESHOLD. Read-only. */)  \
  X(VELOCITY_REACHED, FLAG(10),                                                                    \
    /*!< Actual velocity and target velocity are below VELOCITY_REACHED_THRESHOLD. Read-only. */)  \
  X(ADC_OFFSET_CALIBRATED, FLAG(11),                                                               \
    /*!< The ADC offset was calibrated automatically (clear to recalibrate). Read-write-clear. */) \
  ...
  X(RAMPER_EVENT_STOP_DEVIATION, FLAG(14),                                                         \
    /*!< Ramper had a deviation stop event. Read-write-clear. */)                                  \
  ...
  X(RAMPER_SECOND_MOVE, FLAG(17),                                                                  \
    /*!< The ramper needed a second move to reach target. Read-write-clear. */)                    \
  ...
  X(ABN2_FEEDBACK_AVAILABLE, FLAG(27),                                                             \
    /*!< Signals that ABN2 feedback is available. Read-only. */)                                   \
  X(HALL_FEEDBACK_AVAILABLE, FLAG(28),                                                             \
    /*!< Signals that hall feedback is available. Read-only. */)                                   \
  X(ABN1_FEEDBACK_AVAILABLE, FLAG(29),                                                             \
    /*!< Signals that ABN1 feedback is available. Read-only. */)                                   \
  X(SPI_FLASH_AVAILABLE, FLAG(30),                                                                 \
    /*!< Signals that an external SPI flash is available. Read-only. */)                           \
  X(I2C_EEPROM_AVAILABLE, FLAG(31),                                                                \
    /*!< Signals that an external I2C EEPROM is available. Read-only. */)
 ...
 * FLAG(16) | I2T_1_EXCEEDED               | Signals that I²t limit 1 was exceeded.
 * Read-write-clear. FLAG(17) | I2T_2_EXCEEDED               | Signals that I²t limit 2 was
 * exceeded. Read-write-clear. FLAG(18) | EXT_TEMP_WARNING             | External temperature
 * warning threshold exceeded. Read-write-clear. FLAG(19) | SUPPLY_OVERVOLTAGE_WARNING   | Supply
 * overvoltage warning threshold exceeded. Read-write-clear. FLAG(20) | SUPPLY_UNDERVOLTAGE_WARNING
 * | Supply voltage below undervoltage warning threshold. Read-write-clear. FLAG(21) |
 * ADC_IN_OVERVOLTAGE           | ADC IN over 2V while ADC enabled. Read-write-clear. FLAG(22) |
 * FAULT_RETRY_HAPPENED         | The set number of max. retries was exceeded without recovering.
 * Read-write-clear. FLAG(23) | FAULT_RETRIES_FAILED         | All retries of a detected fault
 * failed. Read-write-clear. FLAG(24) | CHIP_TEMP_WARNING            | Chip temperature warning
 * threshold exceeded. Read-write-clear. FLAG(26) | HEARTBEAT_STOPPED            | Heartbeat
 * stopped. Read-write-clear.
 */
#define GENERAL_ERROR_FLAGS_LIST(X)                                                                \
  ...
  X(EXT_TEMP_WARNING, FLAG(18),                                                                    \
    /*!< External temperature warning threshold exceeded. Read-write-clear. */)                    \
  X(SUPPLY_OVERVOLTAGE_WARNING, FLAG(19),                                                          \
    /*!< Supply overvoltage warning threshold exceeded. Read-write-clear. */)                      \
  X(SUPPLY_UNDERVOLTAGE_WARNING, FLAG(20),                                                         \
    /*!< Supply voltage below undervoltage warning threshold. Read-write-clear. */)                \
  X(ADC_IN_OVERVOLTAGE, FLAG(21), /*!< ADC IN over 2V while ADC enabled. Read-write-clear. */)     \
  X(FAULT_RETRY_HAPPENED, FLAG(22),                                                                \
    /*!< The set number of max. retries was exceeded without recovering. Read-write-clear. */)     \
  X(FAULT_RETRIES_FAILED, FLAG(23),                                                                \
    /*!< All retries of a detected fault failed. Read-write-clear. */)                             \
  X(CHIP_TEMP_WARNING, FLAG(24),                                                                   \
    /*!< Chip temperature warning threshold exceeded. Read-write-clear. */)                        \
...
inline const char *to_string(GateDriverErrorFlags e) {
  switch (e) {
#define X(NAME, VALUE, DOC)                                                                        \
  case GateDriverErrorFlags::NAME:                                                                 \
    return #NAME;
    GATE_DRIVER_ERROR_FLAGS_LIST(X)
#undef X
  default:
